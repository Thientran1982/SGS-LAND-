        ...
        <>
            {open && (
                ...
                >
                    ...
                    <form onSubmit={event => { event.preventDefault(); void send(); }} className="flex items-end gap-2 border-t border-[var(--glass-border)] bg-[var(--glass-surface)] p-3">
                        <textarea
                            value={input}
                            ...
                            rows={1}
                            maxLength={600}
                            className="min-h-10 max-h-24 flex-1 resize-none rounded-xl border border-[var(--glass-border)] bg-[var(--bg-surface)] px-3 py-2.5 text-sm text-[var(--text-primary)] outline-none placeholder:text-[var(--text-muted)] focus:border-[var(--sgs-primary)]"
                            aria-label={copy.placeholder}
                        />
                        <button type="submit" disabled={!input.trim() || sending} className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[var(--sgs-primary)] text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40" aria-label={copy.placeholder}>
                            <Send size={17} />
                        </button>
                    </form>
                </section>
