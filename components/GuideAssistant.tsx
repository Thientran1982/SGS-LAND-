                ...
                >
                    ...
                    <form onSubmit={event => { event.preventDefault(); void send(); }} className="border-t border-[var(--glass-border)] bg-[var(--glass-surface)] p-3">
                        ...
                        <textarea
                            ...
                            rows={1}
                            maxLength={600}
                            className="min-h-10 max-h-24 w-full resize-none rounded-xl border border-[var(--glass-border)] bg-[var(--bg-surface)] px-3 py-2.5 pr-14 text-sm text-[var(--text-primary)] outline-none placeholder:text-[var(--text-muted)] focus:border-[var(--sgs-primary)]"
