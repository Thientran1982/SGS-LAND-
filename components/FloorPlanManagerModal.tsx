          ...
          <section className="rounded-xl border border-[var(--glass-border)] bg-[var(--glass-surface)] p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="A, B1, B2…"
                  maxLength={50}
                  className="w-full px-3 py-2 text-sm rounded-lg border border-[var(--glass-border)] bg-[var(--bg-surface)] focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/30"
                />
              </div>
              <div>
                <label className="text-xs font-bold text-[var(--text-tertiary)] uppercase mb-1 block">
            ...
            <div className="mt-3 flex items-center gap-3 flex-wrap">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-[#C9A84C] text-white text-sm font-bold hover:bg-[#B8860B] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
            ...
            {uploadResult && (
              <div className="mt-4 rounded-lg border border-[#C9A84C] bg-[#FDF6E3] dark:bg-[#B8860B]/20 dark:border-[#B8860B] p-3 space-y-2 text-sm">
                <p className="font-bold text-[#B8860B] dark:text-[#C9A84C]">
                ...
                <p className="text-xs text-[var(--text-secondary)]">
                  ...
                  <span className="font-bold text-[#B8860B] dark:text-[#C9A84C]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    {uploadResult.unmatchedCodes.length === 0 ? (
                      <p className="text-xs text-[#B8860B]">— {t('floorplan.all_matched') || 'tất cả đã khớp'}</p>
                    ) : (
                  ...
                  <div>
                    ...
                    {uploadResult.extraListings.length === 0 ? (
                      <p className="text-xs text-[#B8860B]">— {t('floorplan.all_drawn') || 'tất cả listing đã có vùng'}</p>
                    ) : (
                      <div className="flex flex-wrap gap-1 max-h-24 overflow-auto">
