...
delivery recovery and an approval broker. The current production paths do not
require replaying an arbitrary graph from a node, fan-out/fan-in multi-agent
execution, or human approval suspended between graph nodes.
