...
export const ALL_PROJECTS: DuAnProject[] = [
    ...
    },
    {
        ...
        province: 'TP.HCM',
        scale: 'Nhiều khu vực nội thành',
        priceRange: 'Từ 100 triệu/m² (tham khảo)',
        projectType: 'Nhà phố mặt tiền và nhà hẻm',
        typeGroup: 'Biệt thự & nhà phố',
        status: 'Thứ cấp',
        statusColor: 'emerald',
        img: '/images/projects/aqua-city.png',
        description: 'Danh mục nhà phố mặt tiền, nhà hẻm và shophouse trung tâm TP.HCM. Giá, pháp lý và khả năng khai thác cần được thẩm định theo từng bất động sản trước giao dịch.',
    },
    {
  ...
  {
    slug: 'legacy-66',
     name: 'Legacy 66 Quận 5',
     developer: 'Tân Thành',
     location: 'Chợ Lớn, Quận 5, TP.HCM',
    province: 'TP.HCM',
     scale: '348 căn (tham khảo)',
     priceRange: 'Liên hệ để xác minh',
     projectType: 'Căn hộ cao cấp',
     typeGroup: 'Căn hộ cao cấp',
     status: 'Cần xác minh',
    statusColor: 'emerald',
     img: '/images/projects/aqua-city.png',
     description: 'Căn hộ Legacy 66 tại Chợ Lớn, Quận 5, TP.HCM. Quy mô, sản phẩm, giá, pháp lý và tiến độ cần được xác minh theo hồ sơ hiện hành.',
  },
];
