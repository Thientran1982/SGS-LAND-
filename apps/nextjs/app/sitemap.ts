...
const now = new Date("2026-08-21T00:00:00Z");
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/bao-cao-thi-truong`,          lastModified: now, changeFrequency: "weekly",  priority: 0.9 },
    // Local landing pages
    ...
    { url: `${BASE}/khu-vuc/bat-dong-san-binh-duong`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-quan-7`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-phu-nhuan`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-binh-chanh`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-can-gio`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-hoc-mon`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-binh-duong`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-binh-thanh`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/khu-vuc/bat-dong-san-long-an`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    // Legal
