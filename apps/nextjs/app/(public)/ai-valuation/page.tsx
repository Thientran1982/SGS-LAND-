...
export const metadata: Metadata = {
  ...
  description:
    "Định giá bất động sản tự động bằng AI SGS-AVM v2.1 — sai số ±4.8%, 9 hệ số định giá, chuẩn TĐGVN/IVS. Kết quả tức thì, hoàn toàn miễn phí.",
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
        {[
          { icon: "📊", title: "9 hệ số định giá", desc: "Vị trí, diện tích, pháp lý, tầng, view, nội thất, tiện ích, thanh khoản, hạ tầng" },
          { icon: "🎯", title: "MAPE ±4.8%", desc: "Sai số trung bình tuyệt đối được kiểm định trên 10.000+ giao dịch thực tế Đông Nam Bộ" },
          { icon: "⚡", title: "Kết quả tức thì", desc: "Định giá trong 3 giây — không cần đặt lịch, không cần chờ đợi. 100% tự động." },
        ].map((f) => (
