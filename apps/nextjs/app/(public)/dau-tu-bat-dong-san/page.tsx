...
export const metadata: Metadata = {
  title: "Đầu Tư Bất Động Sản 2025 | Cơ Hội & Chiến Lược | SGS LAND",
  description: "Tư vấn đầu tư BĐS sinh lời 2025: phân tích thị trường, chọn dự án tiềm năng, chiến lược đầu tư dài hạn tại TP.HCM, Đồng Nai, Bình Dương.",
