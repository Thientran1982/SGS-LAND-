// @ts-nocheck
// Shared OpenAPI 3.0 spec for the SGS LAND public API.
// Single source of truth: served at /api/openapi.json (referenced by
// /.well-known/ai-plugin.json) and at /api/public/openapi.
