...
export const AiValuation: React.FC = () => {
    ...
    return (
        ...
        <SeoHead
          ...
          { '@type': 'Question', name: 'Thời gian để có kết quả định giá AI là bao lâu?', acceptedAnswer: { '@type': 'Answer', text: 'Kết quả định giá AI của SGS LAND xuất hiện ngay lập tức — thường trong vòng 2-5 giây sau khi nhập địa chỉ. Hệ thống SGS-AVM phân tích đồng thời hơn 2.400+ giao dịch thực tế gần đó, đối chiếu với dữ liệu quy hoạch từ cổng thông tin chính phủ và chỉ số thị trường cập nhật hàng ngày. Kết quả bao gồm giá trị ước tính, khoảng dao động ±4.8%, và báo cáo PDF có thể tải về. Gói Premium có thêm lịch sử giá 24 tháng và phân tích xu hướng khu vực.' } },
          { '@type': 'Question', name: 'SGS LAND có hỗ trợ định giá bất động sản thương mại không?', acceptedAnswer: { '@type': 'Answer', text: 'Có, SGS-AVM hỗ trợ định giá cả bất động sản thương mại bao gồm: shophouse, nhà phố thương mại, văn phòng, nhà xưởng và đất thương mại. Đối với BĐS thương mại, hệ thống áp dụng thêm các hệ số hiệu chỉnh về mật độ giao thông, khả năng tiếp cận, và tiềm năng kinh doanh khu vực. Độ chính xác cho BĐS thương mại đạt ±6-8%, thấp hơn nhà ở do dữ liệu giao dịch ít hơn. Nên dùng kết quả AI như tham chiếu ban đầu trước khi thuê thẩm định viên chuyên nghiệp.' } },
                    ],
                },
            ]}
        />
                    ...
                    <div className="text-center animate-enter">
                        ...
                        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700 p-2 rounded-2xl max-w-2xl mx-auto flex items-center gap-1 md:gap-2 shadow-2xl relative z-20 group focus-within:ring-2 focus-within:ring-sgs-primary/50 transition-all mt-3">
                            ...
                            <button 
                                ...
                                disabled={!address}
                                className="shrink-0 bg-sgs-primary hover:bg-sgs-primary-deep text-[var(--text-primary)] font-bold px-5 md:px-8 h-12 rounded-xl transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap text-sm md:text-base"
                            >
                                Định Giá →
                            </button>
                        </div>
                        ...
                        <div className="bg-slate-800 rounded-[32px] border border-slate-700 p-8 shadow-2xl">
                            ...
                            <div className="space-y-6">
                                ...
                                <button 
                                    ...
                                    className="w-full bg-sgs-primary hover:bg-sgs-primary-deep text-[var(--text-primary)] font-bold py-4 rounded-xl shadow-lg shadow-sgs-primary/20 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed mt-2 text-lg flex items-center justify-center gap-3"
                                >
                    ...
                    <div className="max-w-xl mx-auto pt-4 animate-enter">
                        {teaserLoading ? (
                            ...
                            <div className="bg-slate-800 rounded-[32px] border border-red-500/30 p-7 md:p-8 shadow-2xl">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-sgs-primary hover:bg-sgs-primary-deep text-[var(--text-primary)] font-bold py-3 rounded-xl transition-all active:scale-95 text-sm flex items-center justify-center gap-2"
                                    >
                            ...
                            <div className="bg-slate-800 rounded-[32px] border border-slate-700 p-7 md:p-8 shadow-2xl">
                                ...
                                <button
                                    onClick={runAdvancedAnalysis}
                                    className="w-full bg-sgs-primary hover:bg-sgs-primary-deep text-[var(--text-primary)] font-bold py-4 rounded-xl shadow-lg shadow-sgs-primary/20 transition-all active:scale-95 text-base flex items-center justify-center gap-2"
                                >
