                ...
                {menuOpen && createPortal(
                    <div
                        ...
                        style={{ position: 'fixed', top: menuPos.top, right: menuPos.right, zIndex: 9999 }}
                         className="w-48 bg-[var(--bg-surface)] rounded-xl border border-[var(--glass-border)] ring-0 outline-none overflow-hidden shadow-none py-1.5 animate-enter"
                    >
        ...
        >
            ...
            {menuOpen && createPortal(
                <div
                    ...
                    onClick={e => e.stopPropagation()}
                    style={{ position: 'fixed', top: menuPos.top, right: menuPos.right, zIndex: 9999 }}
                     className="bg-[var(--bg-surface)] rounded-xl border border-[var(--glass-border)] ring-0 outline-none overflow-hidden shadow-none py-1 min-w-[160px]"
                >
                    <button
