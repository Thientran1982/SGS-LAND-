...
export const Leads: React.FC = () => {
    ...
    return (
        ...
        <div className="h-full flex flex-col relative">
            ...
            {/* Header & Controls */}
            <div className="sticky top-0 z-30 bg-[var(--bg-surface)]/95 backdrop-blur-xl border-b border-[var(--glass-border)] shadow-sm px-4 md:px-6 py-2 md:py-3 transition-all flex-none">
