...
const ALL_PROJECTS: DuAnProject[] = [
    ...
    {
        slug: 'eco-retreat',
        name: 'Eco Retreat Tây Ninh',
        developer: 'Ecopark',
        location: 'Bến Lức, Tây Ninh',
        province: 'Tây Ninh',
        scale: '120 ha',
        priceRange: 'Từ 5,5 tỷ đồng',
        projectType: 'Khu Nghỉ Dưỡng Sinh Thái',
        typeGroup: 'Biệt thự & nhà phố',
        status: 'Đang bán',
        statusColor: 'indigo',
        img: '/images/projects/aqua-city.png',
        description: 'Khu nghỉ dưỡng sinh thái 120ha tại Bến Lức, Tây Ninh. Biệt thự biển, bungalow cao cấp, mô hình cho thuê khai thác. Cách TP.HCM 30 phút.',
    },
];
