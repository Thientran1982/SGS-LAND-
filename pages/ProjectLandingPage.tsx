...
const PROJECT_SEO_META: Record<string, { title: string; description: string }> = {
    ...
    'masteri-park-place': {
      title: 'Masteri Park Place The Global City | Bảng Giá Căn Hộ 2027 - SGS LAND',
      description: 'Masteri Park Place (Masterise Homes) tại The Global City An Phú, Thủ Đức, TP.HCM. Căn hộ 1PN-3PN, view sông & công viên. Giá từ 6,7 tỷ (~120 triệu/m²). Bảng giá toà A1-A2, B1-B2, pháp lý minh bạch. Tư vấn tại SGS LAND.',
    },
    'the-global-city': {
...
const PROJECT_OFFERS: Record<string, { lowPrice: number; highPrice: number; offerCount: number }> = {
    ...
    'masteri-park-place':       { lowPrice: 6_700_000_000, highPrice: 14_500_000_000, offerCount: 200 },
