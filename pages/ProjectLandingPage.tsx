...
const PROJECT_CONFIG: Record<string, ProjectConfig> = {
    ...
    'manhattan': {
        ...
        priceTable: [
          { loaiCan: 'Studio/1PN', dienTich: '35-55 m²', gia: 'Từ 9 tỷ', ghiChu: 'Trung tâm Q.Phú Nhuận' },
          { loaiCan: '2 Phòng Ngủ', dienTich: '70-90 m²', gia: 'Từ 15 tỷ', ghiChu: 'View nội khu/sông' },
          { loaiCan: '3 Phòng Ngủ', dienTich: '100-130 m²', gia: 'Từ 22 tỷ', ghiChu: 'Căn góc premium' },
          { loaiCan: 'Penthouse', dienTich: '200-300 m²', gia: 'Từ 50 tỷ', ghiChu: 'Tầng cao, view toàn TP' },
        ],
        paymentPolicy: 'Thanh toán linh hoạt 30/70; hỗ trợ vay 70% lãi suất 0% 12 tháng; ký HĐMB ngay khi đủ điều kiện pháp lý.',
        relatedProjects: [
    ...
    'izumi-city': {
        ...
        priceTable: [
          { loaiCan: 'Nhà Phố Thương Mại', dienTich: '80-120 m²', gia: 'Từ 8.4 tỷ', ghiChu: 'Mặt tiền đường chính' },
          { loaiCan: 'Biệt Thự Song Lập', dienTich: '150-200 m²', gia: 'Từ 14 tỷ', ghiChu: 'Hồ sinh thái' },
          { loaiCan: 'Biệt Thự Đơn Lập', dienTich: '200-350 m²', gia: 'Từ 22 tỷ', ghiChu: 'Sân vườn riêng' },
          { loaiCan: 'Biệt Thự Vườn Cao Cấp', dienTich: '300-500 m²', gia: 'Từ 30 tỷ', ghiChu: 'Tiện ích 5 sao' },
        ],
        paymentPolicy: 'Thanh toán 20% ký hợp đồng; hỗ trợ vay 70% đến 20 năm; chương trình ưu đãi lãi suất 0% 24 tháng đầu.',
        relatedProjects: [
            { name: 'Aqua City Novaland', slug: 'aqua-city' },
            { name: 'BĐS Đồng Nai', slug: 'bat-dong-san-dong-nai' },
            { name: 'BĐS Long Thành', slug: 'bat-dong-san-long-thanh' },
    ...
    'vinhomes-grand-park': {
        ...
        priceTable: [
          { loaiCan: 'Studio', dienTich: '28-35 m²', gia: 'Từ 1.8 tỷ', ghiChu: 'Phân khu The Rainbow' },
          { loaiCan: '1 Phòng Ngủ', dienTich: '36-50 m²', gia: 'Từ 2.5 tỷ', ghiChu: 'Tầng trung' },
          { loaiCan: '2 Phòng Ngủ', dienTich: '55-75 m²', gia: 'Từ 3.8 tỷ', ghiChu: 'View công viên' },
          { loaiCan: '3 Phòng Ngủ', dienTich: '80-100 m²', gia: 'Từ 6 tỷ', ghiChu: 'Căn góc premium' },
        ],
        paymentPolicy: 'Thanh toán tiêu chuẩn 95% theo tiến độ; hỗ trợ vay 70% lãi suất 0% 18 tháng; nhận nhà ngay khi hoàn tất thủ tục.',
        relatedProjects: [
            { name: 'Vinhomes Central Park', slug: 'vinhomes-central-park' },
    ...
    'vinhomes-central-park': {
        ...
        priceTable: [
          { loaiCan: '1 Phòng Ngủ', dienTich: '45-55 m²', gia: 'Từ 4 tỷ', ghiChu: 'Tháp Landmark 81' },
          { loaiCan: '2 Phòng Ngủ', dienTich: '68-88 m²', gia: 'Từ 7 tỷ', ghiChu: 'View sông Sài Gòn' },
          { loaiCan: '3 Phòng Ngủ', dienTich: '100-130 m²', gia: 'Từ 12 tỷ', ghiChu: 'Căn góc view công viên' },
          { loaiCan: 'Penthouse/Villa', dienTich: '200-400 m²', gia: 'Từ 40 tỷ', ghiChu: 'Tầng cao siêu VIP' },
        ],
        paymentPolicy: 'Thanh toán 30% nhận nhà; hỗ trợ vay 70% ngân hàng đối tác; ưu đãi lãi suất 0% 24 tháng với khách hàng Vinhomes.',
        relatedProjects: [
    ...
    'thu-thiem': {
        ...
        priceTable: [
          { loaiCan: 'Căn Hộ 1PN', dienTich: '50-65 m²', gia: 'Từ 10 tỷ', ghiChu: 'Khu đô thị Thủ Thiêm' },
          { loaiCan: 'Căn Hộ 2PN', dienTich: '75-95 m²', gia: 'Từ 16 tỷ', ghiChu: 'View sông Sài Gòn' },
          { loaiCan: 'Căn Hộ 3PN', dienTich: '100-130 m²', gia: 'Từ 25 tỷ', ghiChu: 'Căn góc cao cấp' },
          { loaiCan: 'Penthouse', dienTich: '200-300 m²', gia: 'Từ 80 tỷ', ghiChu: 'View vịnh Singapore Thủ Thiêm' },
        ],
        paymentPolicy: 'Thanh toán 25% ký HĐMB; hỗ trợ vay ngân hàng đến 70% giá trị; ưu đãi lãi suất 0% 12 tháng đầu tiên.',
        relatedProjects: [
            { name: 'Vinhomes Central Park', slug: 'vinhomes-central-park' },
            { name: 'Masterise Homes', slug: 'masterise-homes' },
            { name: 'BĐS TP Thủ Đức', slug: 'bat-dong-san-thu-duc' },
    ...
    'son-kim-land': {
        ...
        priceTable: [
          { loaiCan: 'Shophouse', dienTich: '80-120 m²', gia: 'Từ 4 tỷ', ghiChu: 'Tầng trệt kinh doanh' },
          { loaiCan: 'Căn Hộ 2PN', dienTich: '65-85 m²', gia: 'Từ 6 tỷ', ghiChu: 'Nội thất hoàn thiện' },
          { loaiCan: 'Căn Hộ 3PN', dienTich: '90-120 m²', gia: 'Từ 10 tỷ', ghiChu: 'View đẹp' },
          { loaiCan: 'Penthouse/Sky Villa', dienTich: '200-400 m²', gia: 'Từ 20 tỷ', ghiChu: 'Sân vườn riêng tầng cao' },
        ],
        paymentPolicy: 'Thanh toán linh hoạt; hỗ trợ vay 65% giá trị bất động sản; ưu đãi đặc biệt cho khách hàng đặt mua sớm.',
        relatedProjects: [
            { name: 'Khu Đô Thị Thủ Thiêm', slug: 'thu-thiem' },
            { name: 'Masterise Homes', slug: 'masterise-homes' },
            { name: 'Vinhomes Central Park', slug: 'vinhomes-central-park' },
    ...
    'masterise-homes': {
        ...
        priceTable: [
          { loaiCan: '1 Phòng Ngủ', dienTich: '40-55 m²', gia: 'Từ 7.5 tỷ', ghiChu: 'Masterise Grand View' },
          { loaiCan: '2 Phòng Ngủ', dienTich: '65-90 m²', gia: 'Từ 12 tỷ', ghiChu: 'Full nội thất Marriott' },
          { loaiCan: '3 Phòng Ngủ', dienTich: '95-130 m²', gia: 'Từ 18 tỷ', ghiChu: 'Căn góc view sông' },
          { loaiCan: 'Sky Villa/Penthouse', dienTich: '200-500 m²', gia: 'Từ 80 tỷ', ghiChu: 'Tiện ích 5 sao quốc tế' },
        ],
        paymentPolicy: 'Thanh toán 30-70 theo tiến độ; hỗ trợ vay 70% đến 25 năm; cam kết thuê lại 5% lợi suất/năm dự án nghỉ dưỡng.',
        relatedProjects: [
            { name: 'The Global City', slug: 'the-global-city' },
            { name: 'Khu Đô Thị Thủ Thiêm', slug: 'thu-thiem' },
            { name: 'Vinhomes Central Park', slug: 'vinhomes-central-park' },
    ...
    'the-global-city': {
        ...
        priceTable: [
          { loaiCan: 'Nhà Phố Thương Mại', dienTich: '100-160 m²', gia: 'Từ 15 tỷ', ghiChu: 'Mặt tiền đại lộ' },
          { loaiCan: 'Biệt Thự Đô Thị', dienTich: '200-300 m²', gia: 'Từ 30 tỷ', ghiChu: 'Hồ sinh thái trung tâm' },
          { loaiCan: 'Căn Hộ Cao Cấp', dienTich: '60-120 m²', gia: 'Từ 8 tỷ', ghiChu: 'Tháp thương mại' },
          { loaiCan: 'Biệt Thự Siêu Sang', dienTich: '350-600 m²', gia: 'Từ 80 tỷ', ghiChu: 'Hạng The Global Luxury' },
        ],
        paymentPolicy: 'Thanh toán 20% ký HĐMB; hỗ trợ vay ngân hàng tối đa 70%; chính sách chiết khấu 3-5% cho khách hàng thanh toán sớm.',
        relatedProjects: [
    ...
    'nha-pho-trung-tam': {
        ...
        priceTable: [
          { loaiCan: 'Nhà Phố 4x15m', dienTich: '60 m²/sàn x 4 tầng', gia: 'Từ 5 tỷ', ghiChu: 'Khu dân cư mới' },
          { loaiCan: 'Nhà Phố 5x18m', dienTich: '90 m²/sàn x 4 tầng', gia: 'Từ 8 tỷ', ghiChu: 'Hẻm thông thoáng' },
          { loaiCan: 'Nhà Phố Mặt Tiền', dienTich: '100 m²/sàn x 4 tầng', gia: 'Từ 12 tỷ', ghiChu: 'Kinh doanh tầng trệt' },
          { loaiCan: 'Nhà Phố Góc', dienTich: '120 m²/sàn x 5 tầng', gia: 'Từ 18 tỷ', ghiChu: '2 mặt tiền' },
        ],
        paymentPolicy: 'Thanh toán linh hoạt theo thỏa thuận; hỗ trợ vay 60-70% giá trị; thủ tục pháp lý đầy đủ sổ đỏ.',
        relatedProjects: [
            { name: 'Khu Đô Thị Thủ Thiêm', slug: 'thu-thiem' },
            { name: 'Vinhomes Central Park', slug: 'vinhomes-central-park' },
            { name: 'The Global City', slug: 'the-global-city' },
    ...
    'vinhomes-can-gio': {
        ...
        priceTable: [
          { loaiCan: 'Căn Hộ 1-2PN', dienTich: '45-80 m²', gia: 'Từ 2.5 tỷ', ghiChu: 'Giai đoạn 1 ưu đãi' },
          { loaiCan: 'Biệt Thự Biển', dienTich: '200-400 m²', gia: 'Từ 12 tỷ', ghiChu: 'View biển trực tiếp' },
          { loaiCan: 'Nhà Phố Resort', dienTich: '100-150 m²', gia: 'Từ 8 tỷ', ghiChu: 'Gần tiện ích trung tâm' },
          { loaiCan: 'Condotel/Homestay', dienTich: '35-60 m²', gia: 'Từ 2 tỷ', ghiChu: 'Cam kết thuê lại' },
        ],
        paymentPolicy: 'Đặt chỗ 50 triệu; thanh toán 5% ký HĐMB; hỗ trợ vay 70% đến 25 năm; cam kết thuê lại 6%/năm với condotel.',
        relatedProjects: [
            { name: 'Vinhomes Grand Park', slug: 'vinhomes-grand-park' },
            { name: 'Aqua City Novaland', slug: 'aqua-city' },
            { name: 'The Global City', slug: 'the-global-city' },
    ...
    'diamond-sky-van-phuc-city': {
        ...
        priceTable: [
          { loaiCan: 'Căn Hộ 1PN', dienTich: '45-60 m²', gia: 'Từ 2.5 tỷ', ghiChu: 'Tầng thấp-trung' },
          { loaiCan: 'Căn Hộ 2PN', dienTich: '65-85 m²', gia: 'Từ 3.8 tỷ', ghiChu: 'View hồ cảnh quan' },
          { loaiCan: 'Căn Hộ 3PN', dienTich: '90-115 m²', gia: 'Từ 5.5 tỷ', ghiChu: 'Căn góc cao tầng' },
          { loaiCan: 'Penthouse/Sky Villa', dienTich: '180-300 m²', gia: 'Từ 9 tỷ', ghiChu: 'Sky lounge riêng' },
        ],
        paymentPolicy: 'Thanh toán 30% nhận nhà; hỗ trợ vay 70% đến 20 năm lãi suất ưu đãi; chính sách chiết khấu 2-4% thanh toán nhanh.',
        relatedProjects: [
            { name: 'Vinhomes Grand Park', slug: 'vinhomes-grand-park' },
            { name: 'The Global City', slug: 'the-global-city' },
  ...
  'vinhomes-hoc-mon': {
        ...
        priceTable: [
          { loaiCan: 'Căn Hộ 1PN', dienTich: '36-50 m²', gia: 'Từ 1.8 tỷ', ghiChu: 'Phân khu Sky Forest' },
          { loaiCan: 'Căn Hộ 2PN', dienTich: '55-72 m²', gia: 'Từ 2.8 tỷ', ghiChu: 'Cạnh công viên 50ha' },
          { loaiCan: 'Căn Hộ 3PN', dienTich: '80-100 m²', gia: 'Từ 4.2 tỷ', ghiChu: 'View hồ/công viên' },
          { loaiCan: 'Nhà Phố/Biệt Thự', dienTich: '100-300 m²', gia: 'Từ 5 tỷ', ghiChu: 'Phân khu thấp tầng' },
        ],
        paymentPolicy: 'Thanh toán theo tiến độ xây dựng; hỗ trợ vay 70% đến 25 năm Vinhomes x Vietcombank; ưu đãi 0% lãi 24 tháng.',
        relatedProjects: [
          { name: 'Aqua City Novaland', slug: 'aqua-city' },
          { name: 'Vinhomes Grand Park', slug: 'vinhomes-grand-park' },
          { name: 'The Global City', slug: 'the-global-city' },
  ...
  'masteri-cosmo-central': {
        ...
        priceTable: [
          { loaiCan: 'Studio/1PN', dienTich: '28-48 m²', gia: 'Từ 2.8 tỷ', ghiChu: 'Tầng trung Thủ Đức' },
          { loaiCan: '2 Phòng Ngủ', dienTich: '56-75 m²', gia: 'Từ 4.5 tỷ', ghiChu: 'Smart home Loxone' },
          { loaiCan: '3 Phòng Ngủ', dienTich: '80-100 m²', gia: 'Từ 7 tỷ', ghiChu: 'View Metro/Hồ' },
          { loaiCan: 'Shophouse/Penthouse', dienTich: '120-250 m²', gia: 'Từ 14 tỷ', ghiChu: 'Tầng cao căn góc' },
        ],
        paymentPolicy: 'Thanh toán 30% nhận nhà; trực tiếp Metro số 1; hỗ trợ vay 70% lãi suất 0% 18 tháng đầu.',
        relatedProjects: [
          { name: 'The Global City', slug: 'the-global-city' },
          { name: 'Vinhomes Grand Park', slug: 'vinhomes-grand-park' },
  ...
  'legacy-66': {
        ...
        priceTable: [
          { loaiCan: 'Căn Hộ 1PN', dienTich: '40-55 m²', gia: 'Từ 2.1 tỷ', ghiChu: 'Gần Aeon Mall Bình Dương' },
          { loaiCan: 'Căn Hộ 2PN', dienTich: '60-80 m²', gia: 'Từ 3.2 tỷ', ghiChu: 'Full nội thất cao cấp' },
          { loaiCan: 'Căn Hộ 3PN', dienTich: '85-105 m²', gia: 'Từ 4.5 tỷ', ghiChu: 'Căn góc view đẹp' },
          { loaiCan: 'Penthouse/Sky Villa', dienTich: '150-220 m²', gia: 'Từ 5.5 tỷ', ghiChu: 'Sân vườn riêng tầng thượng' },
        ],
        paymentPolicy: 'Thanh toán 5% giữ chỗ; 25% ký HĐMB; hỗ trợ vay 70% đến 20 năm; kết nối Vsip 3 - giá trị tăng trưởng bền vững.',
        relatedProjects: [
          { name: 'Aqua City Novaland', slug: 'aqua-city' },
          { name: 'Vinhomes Grand Park', slug: 'vinhomes-grand-park' },
          { name: 'The Global City', slug: 'the-global-city' },
  ...
  'sala': {
    ...
    locationSlug: 'bat-dong-san-thu-duc',
    heroDescription: 'Sala là khu đô thị phức hợp đẳng cấp 98ha toạ lạc ven sông Sài Gòn Thủ Thiêm. Pháp lý sổ đỏ hoàn chỉnh, tiện ích 5 sao, lựa chọn hàng đầu khu Đông TP.HCM.',
    details: [
      { title: 'Chủ đầu tư', items: ['Đại Quang Minh Real Estate'] },
      { title: 'Vị trí', items: ['Mai Chí Thọ, TP Thủ Đức, đối diện Thủ Thiêm'] },
      { title: 'Quy mô', items: ['98 ha, căn hộ, nhà phố, biệt thự và TTTM'] },
      { title: 'Pháp lý', items: ['Sổ đỏ lâu dài, pháp lý hoàn chỉnh 100%'] },
      { title: 'Tiện ích', items: ['Công viên ven sông 12ha', 'TTTM Estella Place', 'Trường quốc tế', 'Hồ bơi ngoài trời'] },
      { title: 'Kết nối', items: ['Cầu Thủ Thiêm 2 kết nối Q.1', 'Metro số 1', 'Sân bay Tân Sơn Nhất 20 phút'] },
      { title: 'Bàn giao', items: ['Đã hoàn thiện, nhận nhà ngay'] },
    ],
    priceTable: [
      { loaiCan: 'Căn Hộ 2PN', dienTich: '70-90 m²', gia: 'Từ 5 tỷ', ghiChu: 'View sông Sài Gòn' },
      { loaiCan: 'Căn Hộ 3PN', dienTich: '95-120 m²', gia: 'Từ 8 tỷ', ghiChu: 'Căn góc cao cấp' },
      { loaiCan: 'Nhà Phố Sala', dienTich: '100-150 m²', gia: 'Từ 15 tỷ', ghiChu: 'Sổ đỏ lâu dài' },
      { loaiCan: 'Biệt Thự Ven Sông', dienTich: '200-400 m²', gia: 'Từ 30 tỷ', ghiChu: 'View sông trực tiếp' },
    ],
    paymentPolicy: 'Thanh toán 30% nhận nhà; hỗ trợ vay 70% ngân hàng đối tác; pháp lý sổ đỏ hoàn chỉnh.',
    faqs: [
      { q: 'Sala Đại Quang Minh ở đâu?', a: 'Tọa lạc tại đường Mai Chí Thọ, TP Thủ Đức, đối diện Thủ Thiêm, cách Q.1 5 phút qua Cầu Thủ Thiêm 2.' },
      { q: 'Giá căn hộ Sala hiện nay là bao nhiêu?', a: 'Căn hộ từ 5-12 tỷ, nhà phố 15-25 tỷ, biệt thự ven sông từ 30 tỷ. Liên hệ SGS LAND cập nhật bảng giá.' },
      { q: 'Sala có sổ đỏ không?', a: 'Có, toàn bộ sản phẩm tại Sala có pháp lý sổ đỏ lâu dài, hoàn chỉnh 100%.' },
      { q: 'Tiện ích nội khu Sala như thế nào?', a: 'Công viên ven sông 12ha, TTTM Estella Place, trường quốc tế, hồ bơi, gym, spa.' },
      { q: 'Sala có phù hợp để đầu tư cho thuê không?', a: 'Rất phù hợp. Lợi suất cho thuê căn hộ 4-5%/năm, nhà phố 3-4%/năm.' },
      { q: 'Sala cách sân bay Tân Sơn Nhất bao xa?', a: 'Khoảng 20-25 phút lái xe qua đường Mai Chí Thọ cầu Sài Gòn.' },
      { q: 'Khu đô thị Sala có bao nhiêu dân số?', a: 'Quy hoạch khoảng 50.000-70.000 cư dân khi hoàn thiện toàn bộ.' },
      { q: 'Căn hộ Sala có tầm nhìn đẹp không?', a: 'View sông Sài Gòn, công viên 12ha hoặc Thủ Thiêm. Tầng cao nhìn panorama TP.HCM.' },
      { q: 'Sala Đại Quang Minh có Metro không?', a: 'Cách ga Metro số 1 (Khu CNC) khoảng 5 phút, di chuyển vào Q.1 chỉ 10-15 phút.' },
      { q: 'Có nên mua Sala ở thời điểm 2025-2026?', a: 'Hợp lý. Khu Đông đang phát triển, Metro sắp vận hành, giá dự báo tăng 15-20%/năm.' },
    ],
    relatedProjects: [
      { name: 'Masteri Cosmo Central', slug: 'masteri-cosmo-central' },
      { name: 'The Global City', slug: 'the-global-city' },
  ...
  'eco-retreat-long-an': {
    ...
    locationSlug: 'bat-dong-san-long-an',
    heroDescription: 'Eco Retreat Long An – khu nghỉ dưỡng sinh thái xanh 500ha tại Cần Giuộc, cách TP.HCM 30 phút. Mật độ xây dựng 30%, cây xanh 70%, hồ điều hòa 15ha. Lựa chọn đầu tư sinh thái tiêu chuẩn 5 sao.',
    details: [
      { title: 'Chủ đầu tư', items: ['Tập đoàn Ecopark'] },
      { title: 'Vị trí', items: ['Cần Giuộc, Long An – 30 phút từ TP.HCM'] },
      { title: 'Quy mô', items: ['500 ha, mật độ xây dựng 30%, cây xanh 70%'] },
      { title: 'Pháp lý', items: ['Sổ đỏ lâu dài, quy hoạch khu đô thị mới'] },
      { title: 'Tiện ích', items: ['Hồ điều hòa 15ha', 'Công viên sinh thái', 'Trường quốc tế', 'TTTM'] },
      { title: 'Kết nối', items: ['QL50 kết nối TP.HCM', 'Đường vành đai 3', 'Cầu Bình Khánh'] },
      { title: 'Loại hình', items: ['Biệt thự nhà vườn, nhà phố liên kế, căn hộ resort'] },
    ],
    priceTable: [
      { loaiCan: 'Nhà Phố Liên Kế', dienTich: '80-120 m²', gia: 'Từ 2.5 tỷ', ghiChu: 'Mặt tiền đường lớn' },
      { loaiCan: 'Biệt Thự Vườn', dienTich: '200-300 m²', gia: 'Từ 5 tỷ', ghiChu: 'Sân vườn riêng' },
      { loaiCan: 'Căn Hộ Resort', dienTich: '45-75 m²', gia: 'Từ 1.2 tỷ', ghiChu: 'View hồ điều hòa' },
      { loaiCan: 'Biệt Thự Hồ', dienTich: '300-500 m²', gia: 'Từ 8 tỷ', ghiChu: 'Trực tiếp view hồ 15ha' },
    ],
    paymentPolicy: 'Đặt cọ 50 triệu; thanh toán 20% ký HĐMB; hỗ trợ vay 70% đến 25 năm.',
    faqs: [
      { q: 'Eco Retreat Long An ở đâu?', a: 'Tọa lạc hủyện Cần Giuộc, Long An, cách TP.HCM 30 phút qua QL50 hoặc vành đai 3.' },
      { q: 'Giá BDS Eco Retreat Long An là bao nhiêu?', a: 'Nhà phố từ 2.5 tỷ, biệt thự vườn từ 5 tỷ, căn hộ resort từ 1.2 tỷ.' },
      { q: 'Eco Retreat Long An có pháp lý không?', a: 'Có sổ đỏ lâu dài, quy hoạch được UBND Long An phê duyệt.' },
      { q: 'Tiện ích tại Eco Retreat Long An như thế nào?', a: 'Hồ điều hòa 15ha, công viên sinh thái, trường quốc tế, TTTM, thể thao, gym.' },
      { q: 'Có nên đầu tư BDS Long An không?', a: 'Long An đang đô thị hóa mạnh. Giá đất tăng 20-30%/năm, tiềm năng cao.' },
      { q: 'Eco Retreat Long An gần Metro không?', a: 'Cách ga cuối Metro số 4 khoảng 10km. Khi Metro hoàn thiện, kết nối Long An – TP.HCM rút ngắn.' },
      { q: 'Mật độ xây dựng Eco Retreat Long An là bao nhiêu?', a: 'Chỉ 30%, 70% còn lại là cây xanh và mặt nước. Mô hình đô thị sinh thái hiếm có.' },
      { q: 'Eco Retreat có phù hợp ở thường xuyên không?', a: 'Rất phù hợp cho gia đình muốn không gian xanh. Đi làm TP.HCM chỉ 30-40 phút.' },
      { q: 'Lợi suất cho thuê tại Eco Retreat Long An?', a: 'Căn hộ resort 5-7%/năm, biệt thự nghỉ dưỡng 6-8%/năm qua mô hình homestay.' },
      { q: 'Eco Retreat Long An có cam kết thuê lại không?', a: 'Có gói cam kết thuê lại cho căn hộ resort với 6%/năm trong 5 năm đầu.' },
    ],
    relatedProjects: [
      { name: 'Vinhomes Cần Giờ', slug: 'vinhomes-can-gio' },
      { name: 'BDS Long An', slug: 'bat-dong-san-long-an' },
      { name: 'Izumi City', slug: 'izumi-city' },
    ],
  },
  'bat-dong-san-dong-nai': {
    ...
    locationSlug: 'bat-dong-san-dong-nai',
    heroDescription: 'Đồng Nai – thị trường BDS bùng nổ nhờ sân bay Long Thành, cao tốc và hạ tầng liên vùng. Đất nền, nhà phố KCN, căn hộ Biên Hòa tăng giá mạnh 30-60%/năm.',
    details: [
      { title: 'Thị trường', items: ['Sân bay Long Thành (2026)', 'Cao tốc TP.HCM – Long Thành', 'Vành đai 3, 4'] },
      { title: 'Giá tham khảo', items: ['Từ 1 – 10 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
      { title: 'Dịch vụ', items: ['Tư vấn miễn phí, pháp lý trọn gói'] },
    ],
    priceTable: [
      { loaiCan: 'Đất Nền', dienTich: '80-200 m²', gia: 'Từ 1 tỷ', ghiChu: 'Pháp lý sổ đỏ' },
      { loaiCan: 'Nhà Phố', dienTich: '60-120 m²', gia: 'Từ 2 tỷ', ghiChu: 'Nhiều lựa chọn' },
      { loaiCan: 'Căn Hộ', dienTich: '45-90 m²', gia: 'Từ 1 tỷ', ghiChu: 'Có sổ hồng' },
      { loaiCan: 'Biệt Thự', dienTich: '200-500 m²', gia: 'Từ 5 tỷ', ghiChu: 'Cao cấp' },
    ],
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Đồng Nai có tiềm năng đầu tư không?', a: 'Rất cao. Đồng Nai – thị trường BDS bùng nổ nhờ sân bay Long Thành, cao tốc và hạ tầng liên vùng. Đất nền, nhà' },
      { q: 'Giá BDS Tỉnh Đồng Nai hiện nay là bao nhiêu?', a: 'Dao động từ 1 – 10 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Tỉnh Đồng Nai có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Tỉnh Đồng Nai đang phát triển như thế nào?', a: 'Sân bay Long Thành (2026) đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Tỉnh Đồng Nai?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Tỉnh Đồng Nai không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Tỉnh Đồng Nai?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Tỉnh Đồng Nai có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Tỉnh Đồng Nai có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Tỉnh Đồng Nai cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Tỉnh Đồng Nai ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Lạc ngoại Bất Động Sản', slug: 'bat-dong-san-long-thanh' },
      { name: 'Izumi City', slug: 'izumi-city' },
      { name: 'BDS Long An', slug: 'bat-dong-san-long-an' },
    ],
  },
  'bat-dong-san-long-thanh': {
    ...
    locationSlug: 'bat-dong-san-dong-nai',
    heroDescription: 'Long Thành – tâm điểm BDS với sân bay quốc tế Long Thành 25 tỷ USD. Đất nền tăng 40-60%, cơ hội đầu tư trước thời điểm sân bay khánh thành 2026.',
    details: [
      { title: 'Thị trường', items: ['Sân bay Long Thành khánh thành 2026', 'Cao tốc Biên Hòa – Vũng Tàu', 'Vành đai 3 Đồng Nai'] },
      { title: 'Giá tham khảo', items: ['Từ 2 – 8 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    priceTable: [
      { loaiCan: 'Đất Nền', dienTich: '80-200 m²', gia: 'Từ 2 tỷ', ghiChu: 'Pháp lý sổ đỏ' },
      { loaiCan: 'Nhà Phố', dienTich: '60-120 m²', gia: 'Từ 4 tỷ', ghiChu: 'Nhiều lựa chọn' },
      { loaiCan: 'Căn Hộ', dienTich: '45-90 m²', gia: 'Từ 2 tỷ', ghiChu: 'Có sổ hồng' },
      { loaiCan: 'Biệt Thự', dienTich: '200-500 m²', gia: 'Từ 4 tỷ', ghiChu: 'Cao cấp' },
    ],
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Long Thành có tiềm năng đầu tư không?', a: 'Rất cao. Long Thành – tâm điểm BDS với sân bay quốc tế Long Thành 25 tỷ USD. Đất nền tăng 40-60%, cơ hội đầu ' },
      { q: 'Giá BDS Huyện Long Thành, Đồng Nai hiện nay là bao nhiêu?', a: 'Dao động từ 2 – 8 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Huyện Long Thành, Đồng Nai có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Huyện Long Thành, Đồng Nai đang phát triển như thế nào?', a: 'Sân bay Long Thành khánh thành 2026 đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Huyện Long Thành, Đồng Nai?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Huyện Long Thành, Đồng Nai không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Huyện Long Thành, Đồng Nai?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Huyện Long Thành, Đồng Nai có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Huyện Long Thành, Đồng Nai có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Huyện Long Thành, Đồng Nai cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Huyện Long Thành, Đồng Nai ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'BDS Đồng Nai', slug: 'bat-dong-san-dong-nai' },
      { name: 'Izumi City', slug: 'izumi-city' },
      { name: 'BDS Thu Duc', slug: 'bat-dong-san-thu-duc' },
    ],
  },
  'bat-dong-san-thu-duc': {
    ...
    name: 'Bất Động Sản Thành Phố Thủ Đức',
    developer: 'Nhiều CĐT',
    location: 'TP Thủ Đức, TP.HCM',
    locationSlug: 'bat-dong-san-thu-duc',
    heroDescription: 'TP Thủ Đức – Silicon Valley Việt Nam với KQHT, Thủ Thiêm, Metro số 1. Giá BDS khu Đông liên tục tăng trưởng, lực đẩy từ kinh tế số và đô thị hóa.',
    details: [
      { title: 'Thị trường', items: ['Metro số 1 (khu CNC)', 'Khu đô thị Thủ Thiêm', 'KQHT ĐH Quốc gia'] },
      { title: 'Giá tham khảo', items: ['Từ 3 – 30 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    priceTable: [
      { loaiCan: 'Đất Nền', dienTich: '80-200 m²', gia: 'Từ 3 tỷ', ghiChu: 'Pháp lý sổ đỏ' },
      { loaiCan: 'Nhà Phố', dienTich: '60-120 m²', gia: 'Từ 6 tỷ', ghiChu: 'Nhiều lựa chọn' },
      { loaiCan: 'Căn Hộ', dienTich: '45-90 m²', gia: 'Từ 3 tỷ', ghiChu: 'Có sổ hồng' },
      { loaiCan: 'Biệt Thự', dienTich: '200-500 m²', gia: 'Từ 15 tỷ', ghiChu: 'Cao cấp' },
    ],
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Thành Phố Thủ Đức có tiềm năng đầu tư không?', a: 'Rất cao. TP Thủ Đức – Silicon Valley Việt Nam với KQHT, Thủ Thiêm, Metro số 1. Giá BDS khu Đông liên tục tăng' },
      { q: 'Giá BDS TP Thủ Đức, TP.HCM hiện nay là bao nhiêu?', a: 'Dao động từ 3 – 30 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS TP Thủ Đức, TP.HCM có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng TP Thủ Đức, TP.HCM đang phát triển như thế nào?', a: 'Metro số 1 (khu CNC) đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại TP Thủ Đức, TP.HCM?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS TP Thủ Đức, TP.HCM không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS TP Thủ Đức, TP.HCM?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS TP Thủ Đức, TP.HCM có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại TP Thủ Đức, TP.HCM có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại TP Thủ Đức, TP.HCM cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS TP Thủ Đức, TP.HCM ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Masteri Cosmo Central', slug: 'masteri-cosmo-central' },
      { name: 'The Global City', slug: 'the-global-city' },
      { name: 'Sala DQM', slug: 'sala' },
    ],
  },
  'bat-dong-san-binh-duong': {
    ...
    heroDescription: 'Bình Dương – thủ phủ công nghiệp miền Nam với hơn 30 KCN. BDS Bình Dương hấp dẫn nhờ giá mềm hơn TP.HCM 40-50% nhưng tiện nghi đầy đủ.',
    details: [
      { title: 'Thị trường', items: ['Vsip 3 – KCN 1000ha', 'Đường N2 kết nối TP.HCM', 'Aeon Mall Bình Dương'] },
      { title: 'Giá tham khảo', items: ['Từ 1 – 8 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Bình Dương có tiềm năng đầu tư không?', a: 'Rất cao. Bình Dương – thủ phủ công nghiệp miền Nam với hơn 30 KCN. BDS Bình Dương hấp dẫn nhờ giá mềm hơn TP.' },
      { q: 'Giá BDS Tỉnh Bình Dương hiện nay là bao nhiêu?', a: 'Dao động từ 1 – 8 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Tỉnh Bình Dương có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Tỉnh Bình Dương đang phát triển như thế nào?', a: 'Vsip 3 – KCN 1000ha đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Tỉnh Bình Dương?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Tỉnh Bình Dương không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Tỉnh Bình Dương?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Tỉnh Bình Dương có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Tỉnh Bình Dương có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Tỉnh Bình Dương cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Tỉnh Bình Dương ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Legacy 66', slug: 'legacy-66' },
      { name: 'BDS Đồng Nai', slug: 'bat-dong-san-dong-nai' },
      { name: 'Vinhomes Hóc Môn', slug: 'vinhomes-hoc-mon' },
    ],
  },
  'bat-dong-san-long-an': {
    ...
    developer: 'Nhiều CĐT',
    location: 'Tỉnh Long An',
    locationSlug: 'bat-dong-san-long-an',
    heroDescription: 'Long An – cửa ngõ phía Nam TP.HCM với quỹ đất lớn, giá mềm và tiềm năng tăng trưởng cao. Vành đai 3-4 và đô thị hóa đang tạo sóng BDS mạnh.',
    details: [
      { title: 'Thị trường', items: ['Vành đai 3, 4 qua Long An', 'QL50 kết nối TP.HCM', 'Cầu Bình Khánh'] },
      { title: 'Giá tham khảo', items: ['Từ 0 – 5 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    priceTable: [
      { loaiCan: 'Đất Nền', dienTich: '80-200 m²', gia: 'Từ 0 tỷ', ghiChu: 'Pháp lý sổ đỏ' },
      { loaiCan: 'Nhà Phố', dienTich: '60-120 m²', gia: 'Từ 0 tỷ', ghiChu: 'Nhiều lựa chọn' },
      { loaiCan: 'Căn Hộ', dienTich: '45-90 m²', gia: 'Từ 1 tỷ', ghiChu: 'Có sổ hồng' },
      { loaiCan: 'Biệt Thự', dienTich: '200-500 m²', gia: 'Từ 2 tỷ', ghiChu: 'Cao cấp' },
    ],
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Long An có tiềm năng đầu tư không?', a: 'Rất cao. Long An – cửa ngõ phía Nam TP.HCM với quỹ đất lớn, giá mềm và tiềm năng tăng trưởng cao. Vành đai 3-' },
      { q: 'Giá BDS Tỉnh Long An hiện nay là bao nhiêu?', a: 'Dao động từ 0 – 5 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Tỉnh Long An có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Tỉnh Long An đang phát triển như thế nào?', a: 'Vành đai 3, 4 qua Long An đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Tỉnh Long An?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Tỉnh Long An không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Tỉnh Long An?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Tỉnh Long An có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Tỉnh Long An có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Tỉnh Long An cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Tỉnh Long An ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Eco Retreat Long An', slug: 'eco-retreat-long-an' },
      { name: 'Izumi City', slug: 'izumi-city' },
      { name: 'BDS Bình Dương', slug: 'bat-dong-san-binh-duong' },
    ],
  },
  'bat-dong-san-phu-nhuan': {
    ...
    locationSlug: 'bat-dong-san-phu-nhuan',
    heroDescription: 'Phú Nhuận – quận trung tâm TP.HCM, giao thông thuận tiện, pháp lý an toàn. Căn hộ và nhà phố Phú Nhuận là lựa chọn ổn định cho gia đình và đầu tư.',
    details: [
      { title: 'Thị trường', items: ['Trung tâm TP.HCM, gần Q.3, Q.Bình Thạnh', 'Metro số 2', 'Sân bay Tân Sơn Nhất 5 phút'] },
      { title: 'Giá tham khảo', items: ['Từ 9 – 50 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    priceTable: [
      { loaiCan: 'Đất Nền', dienTich: '80-200 m²', gia: 'Từ 9 tỷ', ghiChu: 'Pháp lý sổ đỏ' },
      { loaiCan: 'Nhà Phố', dienTich: '60-120 m²', gia: 'Từ 18 tỷ', ghiChu: 'Nhiều lựa chọn' },
      { loaiCan: 'Căn Hộ', dienTich: '45-90 m²', gia: 'Từ 9 tỷ', ghiChu: 'Có sổ hồng' },
      { loaiCan: 'Biệt Thự', dienTich: '200-500 m²', gia: 'Từ 25 tỷ', ghiChu: 'Cao cấp' },
    ],
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Phú Nhuận có tiềm năng đầu tư không?', a: 'Rất cao. Phú Nhuận – quận trung tâm TP.HCM, giao thông thuận tiện, pháp lý an toàn. Căn hộ và nhà phố Phú Nhu' },
      { q: 'Giá BDS Quận Phú Nhuận, TP.HCM hiện nay là bao nhiêu?', a: 'Dao động từ 9 – 50 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Quận Phú Nhuận, TP.HCM có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Quận Phú Nhuận, TP.HCM đang phát triển như thế nào?', a: 'Trung tâm TP.HCM, gần Q.3, Q.Bình Thạnh đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Quận Phú Nhuận, TP.HCM?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Quận Phú Nhuận, TP.HCM không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Quận Phú Nhuận, TP.HCM?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Quận Phú Nhuận, TP.HCM có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Quận Phú Nhuận, TP.HCM có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Quận Phú Nhuận, TP.HCM cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Quận Phú Nhuận, TP.HCM ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Manhattan Novaland', slug: 'manhattan' },
      { name: 'BDS Bình Thạnh', slug: 'bat-dong-san-binh-thanh' },
      { name: 'BDS Q.7', slug: 'bat-dong-san-quan-7' },
    ],
  },
  'bat-dong-san-binh-thanh': {
    ...
    developer: 'Nhiều CĐT',
    location: 'Quận Bình Thạnh, TP.HCM',
    locationSlug: 'bat-dong-san-binh-thanh',
    heroDescription: 'Bình Thạnh – quận đông dân sầm uất, khóa chặt giữa Q.1 và Thủ Thiêm. BDS Bình Thạnh đa dạng từ căn hộ giá tốt đến cao cấp ven sông.',
    details: [
      { title: 'Thị trường', items: ['Giáp Q.1, Thủ Đức', 'Metro số 1 (Thủ Thiêm)', 'Cầu Sài Gòn'] },
      { title: 'Giá tham khảo', items: ['Từ 4 – 25 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    priceTable: [
      { loaiCan: 'Đất Nền', dienTich: '80-200 m²', gia: 'Từ 4 tỷ', ghiChu: 'Pháp lý sổ đỏ' },
      { loaiCan: 'Nhà Phố', dienTich: '60-120 m²', gia: 'Từ 8 tỷ', ghiChu: 'Nhiều lựa chọn' },
      { loaiCan: 'Căn Hộ', dienTich: '45-90 m²', gia: 'Từ 4 tỷ', ghiChu: 'Có sổ hồng' },
      { loaiCan: 'Biệt Thự', dienTich: '200-500 m²', gia: 'Từ 12 tỷ', ghiChu: 'Cao cấp' },
    ],
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Bình Thạnh có tiềm năng đầu tư không?', a: 'Rất cao. Bình Thạnh – quận đông dân sầm uất, khóa chặt giữa Q.1 và Thủ Thiêm. BDS Bình Thạnh đa dạng từ căn h' },
      { q: 'Giá BDS Quận Bình Thạnh, TP.HCM hiện nay là bao nhiêu?', a: 'Dao động từ 4 – 25 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Quận Bình Thạnh, TP.HCM có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Quận Bình Thạnh, TP.HCM đang phát triển như thế nào?', a: 'Giáp Q.1, Thủ Đức đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Quận Bình Thạnh, TP.HCM?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Quận Bình Thạnh, TP.HCM không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Quận Bình Thạnh, TP.HCM?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Quận Bình Thạnh, TP.HCM có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Quận Bình Thạnh, TP.HCM có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Quận Bình Thạnh, TP.HCM cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Quận Bình Thạnh, TP.HCM ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Vinhomes Central Park', slug: 'vinhomes-central-park' },
      { name: 'BDS Phú Nhuận', slug: 'bat-dong-san-phu-nhuan' },
      { name: 'Masterise Homes', slug: 'masterise-homes' },
    ],
  },
  'bat-dong-san-quan-7': {
    ...
    locationSlug: 'bat-dong-san-quan-7',
    heroDescription: 'Quận 7 – khu đô thị hiện đại TP.HCM với Phú Mỹ Hưng, đường Nguyễn Văn Linh. BDS Q.7 ổn định, cộng đồng người nước ngoài đông, giá trị cho thuê cao.',
    details: [
      { title: 'Thị trường', items: ['Phú Mỹ Hưng', 'Nguyễn Văn Linh', 'Cầu Phú Mỹ kết nối Q.4, Q.2'] },
      { title: 'Giá tham khảo', items: ['Từ 5 – 40 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    priceTable: [
      { loaiCan: 'Đất Nền', dienTich: '80-200 m²', gia: 'Từ 5 tỷ', ghiChu: 'Pháp lý sổ đỏ' },
      { loaiCan: 'Nhà Phố', dienTich: '60-120 m²', gia: 'Từ 10 tỷ', ghiChu: 'Nhiều lựa chọn' },
      { loaiCan: 'Căn Hộ', dienTich: '45-90 m²', gia: 'Từ 5 tỷ', ghiChu: 'Có sổ hồng' },
      { loaiCan: 'Biệt Thự', dienTich: '200-500 m²', gia: 'Từ 20 tỷ', ghiChu: 'Cao cấp' },
    ],
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Quận 7 có tiềm năng đầu tư không?', a: 'Rất cao. Quận 7 – khu đô thị hiện đại TP.HCM với Phú Mỹ Hưng, đường Nguyễn Văn Linh. BDS Q.7 ổn định, cộng đồ' },
      { q: 'Giá BDS Quận 7, TP.HCM hiện nay là bao nhiêu?', a: 'Dao động từ 5 – 40 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Quận 7, TP.HCM có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Quận 7, TP.HCM đang phát triển như thế nào?', a: 'Phú Mỹ Hưng đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Quận 7, TP.HCM?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Quận 7, TP.HCM không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Quận 7, TP.HCM?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Quận 7, TP.HCM có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Quận 7, TP.HCM có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Quận 7, TP.HCM cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Quận 7, TP.HCM ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Manhattan Novaland', slug: 'manhattan' },
      { name: 'Son Kim Land', slug: 'son-kim-land' },
      { name: 'BDS Bình Chánh', slug: 'bat-dong-san-binh-chanh' },
    ],
  },
  'bat-dong-san-binh-chanh': {
    ...
    locationSlug: 'bat-dong-san-binh-chanh',
    heroDescription: 'Bình Chánh – vung ngoại ô TP.HCM đang mở rộng đô thị hóa mạnh. Giá đất còn mềm, phù hợp đầu tư dài hạn và xây dựng nhà ở.',
    details: [
      { title: 'Thị trường', items: ['Vành đai 2, 3', 'Cao tốc TP.HCM – Trung Lương', 'Quốc lộ 1A'] },
      { title: 'Giá tham khảo', items: ['Từ 1 – 8 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
    ...
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Bất Động Sản Bình Chánh có tiềm năng đầu tư không?', a: 'Rất cao. Bình Chánh – vung ngoại ô TP.HCM đang mở rộng đô thị hóa mạnh. Giá đất còn mềm, phù hợp đầu tư dài h' },
      { q: 'Giá BDS Huyện Bình Chánh, TP.HCM hiện nay là bao nhiêu?', a: 'Dao động từ 1 – 8 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS Huyện Bình Chánh, TP.HCM có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng Huyện Bình Chánh, TP.HCM đang phát triển như thế nào?', a: 'Vành đai 2, 3 đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại Huyện Bình Chánh, TP.HCM?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS Huyện Bình Chánh, TP.HCM không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS Huyện Bình Chánh, TP.HCM?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS Huyện Bình Chánh, TP.HCM có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại Huyện Bình Chánh, TP.HCM có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại Huyện Bình Chánh, TP.HCM cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS Huyện Bình Chánh, TP.HCM ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'BDS Long An', slug: 'bat-dong-san-long-an' },
      { name: 'BDS Q.7', slug: 'bat-dong-san-quan-7' },
  ...
  'dau-tu-bat-dong-san': {
    ...
    developer: 'SGS LAND',
    location: 'TP.HCM và các tỉnh',
    locationSlug: 'dau-tu-bat-dong-san',
    heroDescription: 'Hướng dẫn đầu tư BDS thông minh tại TP.HCM và vùng lân cận. SGS LAND tư vấn chiến lược, chọn dự án tiềm năng, pháp lý an toàn và tối ưu dòng tiền.',
    details: [
      { title: 'Thị trường', items: ['Chiến lược đầu tư BDS 2025-2030', 'Tự ở hay cho thuê', 'Phân khúc nào tốt nhất'] },
      { title: 'Giá tham khảo', items: ['Từ 1 – 50 tỷ đồng'] },
      { title: 'Pháp lý', items: ['Sổ đỏ/sổ hồng tùy dự án, tư vấn miễn phí'] },
      { title: 'Loại hình', items: ['Đất nền, nhà phố, căn hộ, biệt thự'] },
      { title: 'Tư vấn', items: ['SGS LAND – hotline 0971 132 378'] },
      { title: 'Hỗ trợ vay', items: ['Hỗ trợ vay ngân hàng 60-70% giá trị'] },
    ...
    paymentPolicy: 'Thanh toán linh hoạt theo dự án; hỗ trợ vay 60-70%; tư vấn pháp lý miễn phí từ SGS LAND.',
    faqs: [
      { q: 'Đầu Tư Bất Động Sản có tiềm năng đầu tư không?', a: 'Rất cao. Hướng dẫn đầu tư BDS thông minh tại TP.HCM và vùng lân cận. SGS LAND tư vấn chiến lược, chọn dự án t' },
      { q: 'Giá BDS TP.HCM và các tỉnh hiện nay là bao nhiêu?', a: 'Dao động từ 1 – 50 tỷ tùy loại hình và vị trí. Liên hệ SGS LAND để cập nhật bảng giá mới nhất.' },
      { q: 'Pháp lý BDS TP.HCM và các tỉnh có an toàn không?', a: 'Cần kiểm tra kỹ từng sản phẩm. SGS LAND tư vấn chọn lọ sản phẩm pháp lý sạch, sổ đỏ rõ ràng.' },
      { q: 'Hạ tầng TP.HCM và các tỉnh đang phát triển như thế nào?', a: 'Chiến lược đầu tư BDS 2025-2030 đang được đầu tư mạnh, tạo động lực tăng giá BDS khu vực.' },
      { q: 'Loại hình BDS nào phù hợp tại TP.HCM và các tỉnh?', a: 'Đất nền, nhà phố và căn hộ đều có tiềm năng. Tùy mục tiêu ở thực hay đầu tư dài hạn.' },
      { q: 'Có nên vay ngân hàng mua BDS TP.HCM và các tỉnh không?', a: 'Có thể vay 60-70% giá trị. Lãi suất hỗ trợ 0% 12-24 tháng từ nhiều ngân hàng đối tác.' },
      { q: 'SGS LAND hỗ trợ gì khi mua BDS TP.HCM và các tỉnh?', a: 'Tư vấn miễn phí, chọn lọ sản phẩm, hỗ trợ đàm phán giá và pháp lý trọn gói.' },
      { q: 'Giá BDS TP.HCM và các tỉnh có tăng trong tương lai không?', a: 'Dự báo tăng 15-25%/năm nhờ hạ tầng và đô thị hóa. Thời điểm 2025-2026 là cơ hội tốt.' },
      { q: 'Nhà phố tại TP.HCM và các tỉnh có phù hợp kinh doanh không?', a: 'Rất phù hợp. Nhà phố mặt tiền tại TP.HCM và các tỉnh cho thuê được giá tốt, lợi suất 5-8%/năm.' },
      { q: 'Liên hệ tư vấn BDS TP.HCM và các tỉnh ở đâu?', a: 'Liên hệ SGS LAND qua hotline 0971 132 378 hoặc email info@sgsland.vn. Tư vấn miễn phí 24/7.' },
    ],
    relatedProjects: [
      { name: 'Aqua City Novaland', slug: 'aqua-city' },
      { name: 'Vinhomes Grand Park', slug: 'vinhomes-grand-park' },
            ...
            <section className="bg-gradient-to-br from-[var(--primary-600)]/10 via-[var(--bg-surface)] to-[var(--bg-app)] pt-12 pb-10 px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-wrap items-start gap-3 mb-3">
                        ...
                        <span className="px-3 py-1 rounded-full text-xs font-semibold bg-[#C9A84C]/10 text-[#C9A84C] border border-[#C9A84C]/20">
                            {cfg.priceRange}
                        </span>
                    </div>
                                ...
                                <ul className="space-y-2.5">
                                    {group.items.map((item, ii) => (
                                        <li key={ii} className="flex items-start gap-2.5 text-sm text-[var(--text-secondary)]">
                                            <svg className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
