...
const ICONS = {
    MISSION: <svg className="w-8 h-8 text-[#C9A84C]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
    VISION: <svg className="w-8 h-8 text-[#C9A84C]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /></svg>,
        ...
        <div className="min-h-screen bg-[var(--glass-surface)] font-sans text-[var(--text-primary)] pb-20 overflow-y-auto h-[100dvh] no-scrollbar">
            ...
            <section className="relative py-24 bg-slate-900 text-white overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 text-center animate-enter">
                    <span className="inline-block py-1 px-3 rounded-full bg-[#C9A84C]/20 border border-[#C9A84C]/30 text-[#C9A84C] text-xs font-bold uppercase tracking-widest mb-6">
                        {t('about.hero_badge')}
                    </span>
                    <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
                        {t('about.hero_title')} <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A84C] to-[#C9A84C]">{t('about.hero_title_highlight')}</span>
                    </h1>
            ...
            <section className="py-20 px-6">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 -mt-24 relative z-20">
                    <div className="bg-[var(--bg-surface)] p-8 rounded-[32px] shadow-xl border border-[var(--glass-border)] flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
                        <div className="w-16 h-16 bg-[#FDF6E3] rounded-2xl flex items-center justify-center mb-6">{ICONS.MISSION}</div>
                    ...
                    <div className="bg-[var(--bg-surface)] p-8 rounded-[32px] shadow-xl border border-[var(--glass-border)] flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
                        <div className="w-16 h-16 bg-[#FDF6E3] rounded-2xl flex items-center justify-center mb-6">{ICONS.VISION}</div>
            ...
            <section className="py-16 bg-[var(--bg-surface)] border-y border-[var(--glass-border)]">
                <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                    ...
                    <div>
                        <div className="text-4xl font-black text-[#C9A84C] mb-2">15k+</div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {leaders.map((leader, i) => (
                            <div key={i} className="bg-[var(--bg-surface)] p-6 rounded-[24px] border border-[var(--glass-border)] text-center group hover:border-[#FDF6E3] transition-colors">
                                ...
                                <div className="text-xs font-bold text-[#C9A84C] uppercase tracking-wider mb-4">{leader.role}</div>
