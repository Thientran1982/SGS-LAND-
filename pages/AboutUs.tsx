            ...
            <section className="py-20 px-6">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 -mt-24 relative z-20">
                    <div className="bg-[var(--bg-surface)] p-8 rounded-[32px] shadow-xl border border-[var(--glass-border)] flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <h3 className="text-xl font-bold text-[var(--text-primary)] mb-3">Sứ Mệnh</h3>
                        <p className="text-[var(--text-tertiary)] leading-relaxed">Minh bạch hóa thông tin, đơn giản hóa giao dịch và mang lại giá trị thực cho cộng đồng.</p>
                    </div>
                    <div className="bg-[var(--bg-surface)] p-8 rounded-[32px] shadow-xl border border-[var(--glass-border)] flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
                        <div className="w-16 h-16 bg-emerald-50 rounded-2xl flex items-center justify-center mb-6">{ICONS.VISION}</div>
                        <h3 className="text-xl font-bold text-[var(--text-primary)] mb-3">Tầm Nhìn</h3>
                        <p className="text-[var(--text-tertiary)] leading-relaxed">Trở thành nền tảng PropTech số 1 Đông Nam Á, tích hợp AI toàn diện vào mọi quy trình.</p>
                    </div>
                    <div className="bg-[var(--bg-surface)] p-8 rounded-[32px] shadow-xl border border-[var(--glass-border)] flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
                        <div className="w-16 h-16 bg-rose-50 rounded-2xl flex items-center justify-center mb-6">{ICONS.VALUES}</div>
                        <h3 className="text-xl font-bold text-[var(--text-primary)] mb-3">Giá Trị Cốt Lõi</h3>
                        <p className="text-[var(--text-tertiary)] leading-relaxed">Trung thực, Sáng tạo, Tận tâm và Công nghệ vị nhân sinh.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-4">Đội Ngũ Lãnh Đạo</h2>
                        <p className="text-[var(--text-tertiary)] max-w-2xl mx-auto">Những chuyên gia hàng đầu trong lĩnh vực Bất động sản và Công nghệ.</p>
                    </div>
