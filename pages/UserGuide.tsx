...
/* ─────────────────────────────────────────────
   ...
   weight. Size is set per-usage via className.
───────────────────────────────────────────── */
const Ico = {
    /* navigation / UI */
    ...
    ARROW_LEFT:   <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>,
    ...
    CHECK_CIRCLE: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
    ...
    /* feature grid icons */
    CHART_BAR:    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>,
    FUNNEL:       <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" /></svg>,
    ...
    CHIP:         <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 3H7a2 2 0 00-2 2v2M9 3h6M9 3v2M15 3h2a2 2 0 012 2v2M15 3v2M3 9v6M21 9v6M9 21H7a2 2 0 01-2-2v-2M9 21h6m0 0h2a2 2 0 002-2v-2M15 21v-2M9 5h6v2H9V5zm0 12h6v2H9v-2zM5 9h2v6H5V9zm12 0h2v6h-2V9z" /></svg>,
    NEWSPAPER:    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" /></svg>,
    USERS:        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>,
    TARGET:       <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" strokeWidth={1.5} /><circle cx="12" cy="12" r="5" strokeWidth={1.5} /><circle cx="12" cy="12" r="1" strokeWidth={1.5} /></svg>,
    ...
    TAG:          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z" /></svg>,
    PAPERCLIP:    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" /></svg>,
    ...
    DOCUMENT:     <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>,
    ...
    FOLDER:       <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7z" /></svg>,
    ENVELOPE:     <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>,
    DEVICE:       <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>,
    ...
    PAUSE:        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
    TRENDING_UP:  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>,
    USER_PLUS:    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" /></svg>,
    BOOK_OPEN:    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>,
    ...
    PALETTE:      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v1m2 13a4 4 0 01-4-4V5m4 16a4 4 0 004-4V5a2 2 0 012-2h0a2 2 0 012 2v12a4 4 0 01-4 4H11z" /></svg>,
    CREDIT_CARD:  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>,
    PLUG:         <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
    ...
    PLUS_CIRCLE:  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
...
───────────────────────────────────────────── */
type SectionId =
    | 'quickstart' | 'dashboard' | 'leads' | 'ai-valuation'
    | 'inventory' | 'inbox' | 'contracts' | 'sequences'
    | 'reports' | 'tasks' | 'knowledge' | 'settings';

const NAV_ITEMS: { id: SectionId; label: string; icon: React.ReactNode; color: string }[] = [
    { id: 'quickstart',   label: 'Bắt đầu nhanh',        icon: Ico.QUICKSTART, color: 'emerald' },
    { id: 'dashboard',    label: 'Tổng quan Dashboard',   icon: Ico.DASHBOARD,  color: 'blue'    },
    { id: 'leads',        label: 'Quản lý Lead & CRM',    icon: Ico.LEADS,      color: 'violet'  },
    { id: 'ai-valuation', label: 'Định giá AI (AVM)',     icon: Ico.AI,         color: 'cyan'    },
    { id: 'inventory',    label: 'Kho hàng BĐS',          icon: Ico.INVENTORY,  color: 'amber'   },
    { id: 'inbox',        label: 'Hộp thư đa kênh',       icon: Ico.INBOX,      color: 'pink'    },
    { id: 'contracts',    label: 'Hợp đồng & Đề xuất',   icon: Ico.CONTRACT,   color: 'orange'  },
    { id: 'sequences',    label: 'Chiến dịch tự động',    icon: Ico.SEQUENCE,   color: 'rose'    },
    { id: 'reports',      label: 'Báo cáo & Phân tích',   icon: Ico.REPORT,     color: 'teal'    },
    { id: 'tasks',        label: 'Quản lý Công việc',     icon: Ico.TASK,       color: 'indigo'  },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-5">
            {items.map((it, i) => (
                <div key={i} className="flex gap-3 p-4 rounded-xl bg-slate-800/60 border border-slate-700/60">
                    <span className="text-slate-400 shrink-0 mt-0.5">{it.icon}</span>
                    <div>
...
const PIPELINE_STAGES: { label: string; icon: React.ReactNode }[] = [
    ...
    { label: 'Liên hệ',  icon: Ico.PHONE       },
    { label: 'Tư vấn',   icon: Ico.LIGHTBULB   },
    { label: 'Xem nhà',  icon: Ico.INVENTORY   },
...
const QUICK_LINKS: { href: string; label: string; icon: React.ReactNode }[] = [
    ...
    { href: '/#/leads',        label: 'Quản lý Lead',    icon: Ico.LEADS      },
    { href: '/#/ai-valuation', label: 'Định giá AI',     icon: Ico.AI         },
    { href: '/#/inventory',    label: 'Kho hàng',        icon: Ico.INVENTORY  },
...
const SECTIONS: Record<SectionId, React.ReactNode> = {
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    {QUICK_LINKS.map(({ href, label, icon }) => (
                        <a key={href} href={href}
                            className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-700/50 hover:bg-slate-700 text-slate-300 hover:text-white text-xs font-medium transition-all">
    ...
    'dashboard': (
        <section id="dashboard">
            ...
            <FeatureGrid items={[
                { icon: Ico.CHART_BAR,   title: 'KPI Tổng quan',         desc: 'Tổng lead, lead mới hôm nay, tỷ lệ chuyển đổi, doanh số tháng, hoa hồng dự kiến — cập nhật real-time.' },
                { icon: Ico.FUNNEL,      title: 'Pipeline Funnel',        desc: 'Biểu đồ pipeline theo 6 giai đoạn: Mới → Liên hệ → Tư vấn → Xem nhà → Đàm phán → Chốt. Kéo thả trực tiếp.' },
                { icon: Ico.CALENDAR,    title: 'Hoạt động hôm nay',      desc: 'Danh sách cuộc hẹn, follow-up đến hạn, lead chưa phản hồi quá 24 giờ — cảnh báo ưu tiên cao.' },
                { icon: Ico.CHIP,        title: 'Gợi ý AI',               desc: 'AI phân tích điểm lead và đề xuất hành động tiếp theo: "Gọi điện cho Nguyễn Văn A", "Gửi báo giá cho Trần Thị B".' },
                { icon: Ico.NEWSPAPER,   title: 'Tin tức thị trường',     desc: 'Tin tức BĐS mới nhất từ các nguồn uy tín (CafeF, BatDongSan.com.vn), lọc theo khu vực bạn theo dõi.' },
                { icon: Ico.USERS,       title: 'Bảng xếp hạng nhóm',    desc: 'So sánh hiệu suất theo team, chi nhánh — hiển thị ai đang dẫn đầu trong tuần/tháng.' },
            ]} />
    ...
    'leads': (
        <section id="leads">
            ...
            <FeatureGrid items={[
                { icon: Ico.TARGET,    title: 'Chấm điểm AI (Lead Scoring)', desc: '12 tiêu chí: hành vi, ngân sách, khu vực mong muốn, thời gian phản hồi… AI chấm 0–100 điểm, tự động xếp loại Hot/Warm/Cold.' },
                { icon: Ico.REFRESH,   title: 'Tự động phân công (Auto-assign)', desc: 'Cài Routing Rules → lead mới tự động phân về đúng nhân viên theo khu vực, loại BĐS, ngân sách, vòng xoay công bằng.' },
                { icon: Ico.CLIPBOARD, title: 'Lịch sử tương tác đầy đủ', desc: 'Mọi cuộc gọi, tin nhắn Zalo, email, comment đều ghi lại vào timeline lead. Không bỏ sót bất kỳ thông tin nào.' },
                { icon: Ico.TAG,       title: 'Tag & lọc nâng cao', desc: 'Gắn tag tùy chỉnh, lọc theo 20+ tiêu chí: nguồn lead, khu vực, ngân sách, điểm AI, ngày tạo, nhân viên phụ trách.' },
                { icon: Ico.PAPERCLIP, title: 'Đính kèm tài liệu', desc: 'Upload CCCD, sao kê ngân hàng, yêu cầu khách hàng trực tiếp vào hồ sơ lead. Mã hóa AES-256.' },
                { icon: Ico.CHART_BAR, title: 'Báo cáo lead chi tiết', desc: 'Tỷ lệ chuyển đổi theo từng giai đoạn, nguồn lead hiệu quả nhất, thời gian trung bình chốt deal.' },
            ]} />
            ...
            <Tip>
                Lead có điểm từ 70 trở lên được đánh dấu{' '}
                <span className="inline-flex items-center gap-1 text-rose-400 font-semibold">
                    <span>{Ico.FIRE}</span>Hot
                </span>{' '}
                — ưu tiên liên hệ trong 2 giờ đầu để tối đa tỷ lệ chuyển đổi.
            </Tip>
        </section>
    ),
    ...
    'inventory': (
        <section id="inventory">
            ...
            <FeatureGrid items={[
                { icon: Ico.BUILDING,   title: 'Đa loại BĐS',         desc: 'Căn hộ, nhà phố, biệt thự, đất nền, kho xưởng, shophouse, penthouse, nhà phố thương mại.' },
                { icon: Ico.CAMERA,     title: 'Quản lý ảnh & media', desc: 'Upload tối đa 50 ảnh/BĐS, video tour 360°, sắp xếp thứ tự ảnh, watermark thương hiệu tự động.' },
                { icon: Ico.SEARCH,     title: 'Tìm kiếm & lọc',      desc: 'Lọc theo loại, khu vực, giá, diện tích, tình trạng (đang bán/cho thuê/đã giao), nhân viên phụ trách.' },
                { icon: Ico.CHIP,       title: 'Gợi ý khớp lead',     desc: 'AI tự động gợi ý BĐS phù hợp với từng lead dựa trên tiêu chí tìm kiếm, ngân sách và khu vực ưu tiên.' },
                { icon: Ico.CHART_BAR,  title: 'Thống kê lượt xem',   desc: 'Theo dõi lượt xem từng BĐS trên Marketplace, số lần yêu thích, số lần yêu cầu xem nhà.' },
                { icon: Ico.SHARE,      title: 'Chia sẻ nhanh',       desc: 'Tạo link chia sẻ BĐS cá nhân hóa (kèm logo môi giới), đăng thẳng lên Zalo, Facebook chỉ 1 click.' },
            ]} />
    ...
    'inbox': (
        <section id="inbox">
            ...
            <FeatureGrid items={[
                { icon: Ico.CHAT,      title: 'Hợp nhất 3 kênh',         desc: 'Zalo OA, Facebook Messenger, Email — tất cả hiển thị trong cùng 1 giao diện. Trả lời đúng kênh chỉ bằng 1 cửa sổ.' },
                { icon: Ico.BOLT,      title: 'Trả lời nhanh AI',         desc: 'AI gợi ý câu trả lời phù hợp dựa trên lịch sử chat, thông tin BĐS liên quan và kịch bản sales đã cài.' },
                { icon: Ico.USER,      title: 'Gắn vào lead tự động',     desc: 'Tin nhắn từ số điện thoại/email đã có trong hệ thống tự động gắn vào hồ sơ lead tương ứng.' },
                { icon: Ico.CLIPBOARD, title: 'Template tin nhắn',        desc: 'Tạo sẵn kho template (giới thiệu BĐS, lịch xem nhà, xác nhận đặt cọc…) — chèn vào chat 1 click.' },
                { icon: Ico.BELL,      title: 'Thông báo real-time',      desc: 'Nhận thông báo trình duyệt ngay khi có tin nhắn mới. Hiển thị badge đếm tin chưa đọc trên icon inbox.' },
                { icon: Ico.TAG,       title: 'Phân loại & ưu tiên',      desc: 'Gắn nhãn (Nóng/Cần theo dõi/Chờ tài liệu), lọc theo kênh, nhân viên, trạng thái xử lý.' },
            ]} />
    ...
    'contracts': (
        <section id="contracts">
            ...
            <FeatureGrid items={[
                { icon: Ico.DOCUMENT,     title: 'Hợp đồng môi giới',      desc: 'Tạo hợp đồng từ template, điền thông tin BĐS và khách hàng tự động, xuất PDF chuyên nghiệp.' },
                { icon: Ico.CURRENCY,     title: 'Đề xuất tài chính',       desc: 'Trình bày phương án thanh toán, lịch trả góp ngân hàng, hoa hồng môi giới — dạng tài liệu đẹp gửi cho khách.' },
                { icon: Ico.LINK,         title: 'Link chia sẻ công khai',  desc: 'Mỗi hợp đồng/đề xuất có URL riêng, khách hàng xem qua trình duyệt, không cần tài khoản.' },
                { icon: Ico.CHECK_CIRCLE, title: 'Luồng phê duyệt',         desc: 'Hợp đồng cần qua duyệt cấp trên trước khi gửi khách. Theo dõi trạng thái: Nháp → Chờ duyệt → Đã duyệt → Đã gửi.' },
                { icon: Ico.CHART_BAR,    title: 'Theo dõi trạng thái',     desc: 'Biết khách đã mở link, đã đọc trang nào, đã ký hay chưa — thông báo ngay khi có hành động.' },
                { icon: Ico.FOLDER,       title: 'Lưu trữ & tìm kiếm',     desc: 'Toàn bộ hợp đồng lưu trên hệ thống, tìm kiếm theo tên khách/BĐS/ngày ký, xuất báo cáo Excel.' },
            ]} />
    ...
    'sequences': (
        <section id="sequences">
            ...
            <FeatureGrid items={[
                { icon: Ico.ENVELOPE,  title: 'Email tự động',           desc: 'Gửi email chào mừng, giới thiệu BĐS mới, nhắc xem nhà, chúc mừng sinh nhật — theo trigger hoặc lịch trình.' },
                { icon: Ico.DEVICE,    title: 'Tin Zalo OA tự động',     desc: 'Gửi tin Zalo theo template ZNS (Zalo Notification Service) khi lead đổi trạng thái, hợp đồng sắp hết hạn.' },
                { icon: Ico.CLOCK,     title: 'Tạo nhắc việc tự động',   desc: 'Tự tạo task "Gọi điện sau 3 ngày", "Gửi báo giá sau 1 tuần" cho nhân viên phụ trách lead.' },
                { icon: Ico.TARGET,    title: 'Trigger đa điều kiện',    desc: 'Kích hoạt khi lead được tạo, khi lead đổi giai đoạn, khi BĐS mới phù hợp nhu cầu, khi không phản hồi sau X ngày.' },
                { icon: Ico.CHART_BAR, title: 'Báo cáo hiệu quả',        desc: 'Tỷ lệ mở email, tỷ lệ click, số lead phản hồi sau campaign — so sánh giữa các sequence.' },
                { icon: Ico.PAUSE,     title: 'Tạm dừng thông minh',     desc: 'Tự động dừng sequence khi khách đã phản hồi, tránh spam. Khởi động lại khi khách im lặng trở lại.' },
            ]} />
    ...
    'reports': (
        <section id="reports">
            ...
            <FeatureGrid items={[
                { icon: Ico.TRENDING_UP, title: 'Báo cáo doanh số',          desc: 'Doanh số theo ngày/tuần/tháng/quý, so sánh kỳ trước, biểu đồ xu hướng, breakdown theo nhân viên và chi nhánh.' },
                { icon: Ico.TARGET,      title: 'Báo cáo lead & conversion', desc: 'Tổng lead vào, tỷ lệ chuyển đổi từng giai đoạn pipeline, nguồn lead hiệu quả nhất, thời gian trung bình từ lead đến chốt.' },
                { icon: Ico.USERS,       title: 'Hiệu suất nhân viên',       desc: 'So sánh số lead, số cuộc hẹn, số chốt, hoa hồng giữa các nhân viên — bảng xếp hạng realtime.' },
                { icon: Ico.BUILDING,    title: 'Báo cáo kho hàng',          desc: 'BĐS bán nhanh nhất, BĐS tồn kho lâu nhất, phân tích theo loại BĐS, khu vực, phân khúc giá.' },
                { icon: Ico.DEVICE,      title: 'Báo cáo kênh liên lạc',     desc: 'Tỷ lệ phản hồi theo kênh (Zalo vs Facebook vs Email), thời điểm khách hàng hoạt động nhiều nhất.' },
                { icon: Ico.DOWNLOAD,    title: 'Xuất Excel/PDF',             desc: 'Xuất mọi báo cáo ra Excel hoặc PDF với 1 click. Lên lịch gửi báo cáo tự động qua email hàng tuần.' },
            ]} />
    ...
    'tasks': (
        <section id="tasks">
            ...
            <FeatureGrid items={[
                { icon: Ico.KANBAN,    title: 'Kanban Board',           desc: 'Kéo thả task qua các cột: Việc cần làm → Đang xử lý → Chờ phản hồi → Hoàn thành. Cập nhật real-time qua WebSocket.' },
                { icon: Ico.USER_PLUS, title: 'Phân công nhân viên',   desc: 'Giao task cho cá nhân hoặc cả nhóm, đặt deadline, mức độ ưu tiên (Thấp/Trung bình/Cao/Khẩn cấp).' },
                { icon: Ico.LINK,      title: 'Gắn vào Lead/BĐS',      desc: 'Task "Gọi điện cho khách A" gắn trực tiếp vào hồ sơ lead, "Chụp ảnh BĐS" gắn vào kho hàng.' },
                { icon: Ico.CALENDAR,  title: 'Nhắc nhở tự động',      desc: 'Cảnh báo task sắp đến hạn qua thông báo trình duyệt và email 30 phút, 1 giờ, 1 ngày trước.' },
                { icon: Ico.CHAT,      title: 'Bình luận & phản hồi',  desc: 'Để lại comment, đính kèm ảnh/tài liệu vào task, tag đồng nghiệp bằng @mention.' },
                { icon: Ico.CHART_BAR, title: 'Báo cáo hiệu suất',     desc: 'Số task hoàn thành đúng hạn vs trễ hạn, workload theo nhân viên, bottleneck trong team.' },
            ]} />
        </section>
    ),
    ...
    'knowledge': (
        <section id="knowledge">
            ...
            <FeatureGrid items={[
                { icon: Ico.BOOK_OPEN, title: 'Bài viết & Quy trình',      desc: 'Viết và lưu quy trình bán hàng, kịch bản tư vấn, hướng dẫn pháp lý — format rich text với tiêu đề, hình ảnh, bảng biểu.' },
                { icon: Ico.CHIP,      title: 'AI truy xuất tự động',      desc: 'Khi có câu hỏi phức tạp từ khách hàng trên Inbox, AI tìm và trả lời dựa trên nội dung trong Knowledge Base.' },
                { icon: Ico.TAG,       title: 'Phân loại theo danh mục',  desc: 'Phân loại: Pháp lý BĐS / Thông tin dự án / Quy trình nội bộ / Chính sách công ty / FAQ khách hàng.' },
                { icon: Ico.SEARCH,    title: 'Tìm kiếm toàn văn',        desc: 'Tìm kiếm ngay kết quả trong toàn bộ nội dung — hỗ trợ tiếng Việt có dấu và không dấu.' },
                { icon: Ico.LOCK,      title: 'Phân quyền nội dung',      desc: 'Bài viết có thể đặt chế độ: Public (mọi nhân viên thấy) / Private (chỉ Admin) / Team (chỉ nhóm cụ thể).' },
                { icon: Ico.CHART_BAR, title: 'Thống kê truy cập',        desc: 'Bài viết nào được xem nhiều nhất, nhân viên nào sử dụng nhiều, tỷ lệ AI trả lời đúng từ knowledge.' },
            ]} />
    ...
    'settings': (
        <section id="settings">
            ...
            <FeatureGrid items={[
                { icon: Ico.USERS,       title: 'Quản lý nhân viên',        desc: 'Thêm/xóa nhân viên, phân quyền (Admin/Manager/Agent), đặt quota lead hàng tháng.' },
                { icon: Ico.BUILDING,    title: 'Cấu hình chi nhánh',       desc: 'Tạo và quản lý nhiều chi nhánh, phân công nhân viên theo chi nhánh, báo cáo tách biệt.' },
                { icon: Ico.PALETTE,     title: 'Thương hiệu doanh nghiệp', desc: 'Upload logo, đặt màu chủ đạo, tùy chỉnh tên miền hiển thị trên link chia sẻ và email.' },
                { icon: Ico.CREDIT_CARD, title: 'Gói dịch vụ & Thanh toán', desc: 'Xem gói hiện tại, nâng cấp lên Enterprise, lịch sử hóa đơn, thêm phương thức thanh toán.' },
                { icon: Ico.SHIELD,      title: 'Bảo mật & Tuân thủ',      desc: 'Cài chính sách mật khẩu, xem nhật ký truy cập (Audit Log), xuất dữ liệu GDPR.' },
                { icon: Ico.PLUG,        title: 'Tích hợp bên thứ ba',      desc: 'Kết nối Zalo OA, Facebook Page, Brevo Email, webhook tùy chỉnh, API key cho developer.' },
            ]} />
