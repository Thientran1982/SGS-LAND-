...
const PROJECTS_DATA = [
  { slug: 'aqua-city',               image: '/images/projects/aqua-city.webp',               vi: { name: 'Aqua City',           dev: 'Novaland',  loc: 'Biên Hòa, Đồng Nai', price: 'Từ 6 tỷ',    badge: 'Hot',         type: 'Đô Thị Sinh Thái' }, en: { name: 'Aqua City',           dev: 'Novaland',  loc: 'Bien Hoa, Dong Nai', price: 'From 6B',    badge: 'Hot',         type: 'Eco Township' } },
  { slug: 'the-global-city',         image: '/images/projects/the-global-city.webp',         vi: { name: 'The Global City',     dev: 'Masterise', loc: 'Thủ Đức, TP.HCM',    price: 'Từ 4,5 tỷ',  badge: 'Cao Cấp',     type: 'Đô Thị Tài Chính' }, en: { name: 'The Global City',     dev: 'Masterise', loc: 'Thu Duc, HCMC',     price: 'From 4.5B',  badge: 'Premium',     type: 'Financial Township' } },
  { slug: 'vinhomes-can-gio',        image: '/images/projects/vinhomes-can-gio.webp',        vi: { name: 'Vinhomes Cần Giờ',   dev: 'Vinhomes',  loc: 'Cần Giờ, TP.HCM',    price: 'Từ 12 tỷ',   badge: 'Mega',        type: 'Đô Thị Biển' },    en: { name: 'Vinhomes Can Gio',    dev: 'Vinhomes',  loc: 'Can Gio, HCMC',     price: 'From 12B',   badge: 'Mega',        type: 'Coastal City' } },
  { slug: 'izumi-city',              image: '/images/projects/izumi-city.webp',              vi: { name: 'Izumi City',          dev: 'Nam Long',  loc: 'Biên Hòa, Đồng Nai', price: 'Từ 8,4 tỷ',  badge: 'Nhật Bản',    type: 'Chuẩn Nhật Bản' }, en: { name: 'Izumi City',          dev: 'Nam Long',  loc: 'Bien Hoa, Dong Nai', price: 'From 8.4B',  badge: 'Japanese',    type: 'Japanese Standard' } },
  { slug: 'vinhomes-grand-park',     image: '/images/projects/vinhomes-grand-park.webp',     vi: { name: 'Vinhomes Grand Park', dev: 'Vinhomes',  loc: 'Thủ Đức, TP.HCM',    price: 'Từ 1,8 tỷ',  badge: 'Best Seller', type: 'Đại Đô Thị' },    en: { name: 'Vinhomes Grand Park', dev: 'Vinhomes',  loc: 'Thu Duc, HCMC',     price: 'From 1.8B',  badge: 'Best Seller', type: 'Grand Township' } },
  { slug: 'diamond-sky-van-phuc-city', image: '/images/projects/diamond-sky-van-phuc-city.webp', vi: { name: 'Diamond Sky',     dev: 'Van Phúc',  loc: 'Thủ Đức, TP.HCM',    price: 'Từ 9,6 tỷ',  badge: 'Cao Cấp',     type: 'Căn Hộ View Sông' }, en: { name: 'Diamond Sky',         dev: 'Van Phuc',  loc: 'Thu Duc, HCMC',     price: 'From 9.6B',  badge: 'Premium',     type: 'River View' } },
];
