...
export const Landing: React.FC = () => {
    ...
    return (
        <div className="bg-[var(--bg-surface)] dark:bg-slate-900 text-[var(--text-primary)] dark:text-white font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden min-h-[100dvh] transition-colors duration-300">
            ...
            {/* HERO SECTION */}
            <section className={`relative ${currentUser ? 'pt-8 md:pt-12' : 'pt-32 md:pt-40'} pb-12 md:pb-16 px-6 overflow-hidden min-h-[90svh] flex flex-col justify-center items-center`}>
                {/* Background Decor */}
                <motion.div 
                    animate={{ 
                        scale: [1, 1.05, 1],
            ...
            <section className="py-10 md:py-14 px-6 bg-[var(--glass-surface)]/50 dark:bg-slate-900/50 border-y border-[var(--glass-border)] dark:border-slate-800 backdrop-blur-sm">
            ...
            <section className="py-14 md:py-20 bg-[var(--glass-surface)] dark:bg-slate-900/50 border-t border-[var(--glass-border)] dark:border-slate-800">
            ...
            {/* CTA */}
            <section className="py-14 md:py-20 px-6 text-center relative overflow-hidden bg-slate-900">
                <motion.div 
                    animate={{ rotate: 360 }}
