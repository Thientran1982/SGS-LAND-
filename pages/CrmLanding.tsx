...
export const CrmLanding: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-slate-900 pb-20 overflow-y-auto h-[100dvh] no-scrollbar">
            {/* Header */}
            <div className="sticky top-0 bg-white/90 backdrop-blur-md z-50 border-b border-slate-100">
            ...
            <section className="pt-24 pb-32 px-6 text-center max-w-5xl mx-auto animate-enter">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button className="px-8 py-4 bg-white text-slate-700 border border-slate-200 font-bold rounded-2xl text-lg hover:bg-slate-50 transition-colors">
                        Xem Demo
                    </button>
                </div>
            </section>
            ...
            <section className="px-4 md:px-6 mb-24 max-w-[1440px] mx-auto">
                <div className="rounded-[32px] overflow-hidden shadow-2xl border border-slate-200 bg-slate-50 relative group">
                    <div className="absolute top-0 left-0 right-0 h-12 bg-white border-b border-slate-100 flex items-center px-4 gap-2">
                        ...
                        <div className="ml-4 w-64 h-6 bg-slate-100 rounded-lg"></div>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                        <div className="space-y-4">
                            ...
                            <h3 className="text-xl font-bold text-slate-900">Phân Hạng Khách Hàng AI</h3>
                        ...
                        <div className="space-y-4">
                            ...
                            <h3 className="text-xl font-bold text-slate-900">Chuỗi Tự Động Hóa</h3>
                            <p className="text-slate-500 leading-relaxed text-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            <h3 className="text-xl font-bold text-slate-900">Báo Cáo Thời Gian Thực</h3>
                            <p className="text-slate-500 leading-relaxed text-sm">
            ...
            <section className="py-24 px-6 max-w-4xl mx-auto text-center">
                <h2 className="text-3xl font-bold text-slate-900 mb-12">Bảng Giá Đơn Giản</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm hover:shadow-xl transition-all">
                        <h3 className="text-lg font-bold text-slate-500 uppercase tracking-wide mb-2">Cơ Bản</h3>
                        <div className="text-4xl font-black text-slate-900 mb-6">499k <span className="text-lg font-medium text-slate-400">/ tháng</span></div>
                        <ul className="space-y-3 mb-8">
                            <li className="flex gap-3 text-slate-600"><span className="text-emerald-500">{ICONS.CHECK}</span> 5 Tài khoản nhân viên</li>
                            <li className="flex gap-3 text-slate-600"><span className="text-emerald-500">{ICONS.CHECK}</span> 2,000 Khách hàng</li>
                            <li className="flex gap-3 text-slate-600"><span className="text-emerald-500">{ICONS.CHECK}</span> Email Marketing cơ bản</li>
                        </ul>
                        <button onClick={handleLogin} className="w-full py-3 bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold rounded-xl transition-colors">{currentUser ? t('menu.dashboard') : 'Đăng Ký Ngay'}</button>
                    </div>
                    <div className="bg-slate-900 text-white p-8 rounded-[32px] shadow-2xl relative overflow-hidden transform hover:-translate-y-2 transition-all">
                        ...
                        <div className="text-4xl font-black text-white mb-6">1,999k <span className="text-lg font-medium text-slate-500">/ tháng</span></div>
                        <ul className="space-y-3 mb-8">
