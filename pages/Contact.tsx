            ...
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 animate-enter">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                        ...
                        <div className="bg-[var(--bg-surface)] p-8 rounded-[32px] border border-[var(--glass-border)] shadow-xl">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 bg-[#FDF6E3] text-[#C9A84C] rounded-2xl flex items-center justify-center shrink-0">
                                        {ICONS.MAP_PIN}
                                    </div>
                                    <div>
                    ...
                    <div className="bg-[var(--bg-surface)] p-8 md:p-10 rounded-[40px] border border-[var(--glass-border)] shadow-2xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-[#FDF6E3] rounded-full blur-[80px] -mr-20 -mt-20 opacity-60 pointer-events-none"></div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="space-y-1 group">
                                    <label className="text-xs font-bold text-[var(--text-tertiary)] uppercase ml-1 group-focus-within:text-[#C9A84C] transition-colors">{t('contact.label_name')} <span className="text-rose-500">*</span></label>
                                    <input
                                        type="text"
                                        className={`w-full border rounded-xl px-4 py-3 text-[16px] outline-none focus:ring-2 transition-all ${errors.name ? 'border-rose-300 bg-rose-50 focus:ring-rose-500/20' : 'bg-[var(--glass-surface)] border-[var(--glass-border)] focus:ring-[#C9A84C]/20 focus:border-[#C9A84C] focus:bg-[var(--bg-surface)]'}`}
                                ...
                                <div className="space-y-1 group">
                                    <label className="text-xs font-bold text-[var(--text-tertiary)] uppercase ml-1 group-focus-within:text-[#C9A84C] transition-colors">{t('contact.label_email')} <span className="text-rose-500">*</span></label>
                                    <input
                                        type="email"
                                        className={`w-full border rounded-xl px-4 py-3 text-[16px] outline-none focus:ring-2 transition-all ${errors.email ? 'border-rose-300 bg-rose-50 focus:ring-rose-500/20' : 'bg-[var(--glass-surface)] border-[var(--glass-border)] focus:ring-[#C9A84C]/20 focus:border-[#C9A84C] focus:bg-[var(--bg-surface)]'}`}
                            ...
                            <div className="space-y-1 group">
                                <label className="text-xs font-bold text-[var(--text-tertiary)] uppercase ml-1 group-focus-within:text-[#C9A84C] transition-colors">{t('contact.label_message')} <span className="text-rose-500">*</span></label>
                                <textarea
                                    rows={5}
                                    className={`w-full border rounded-xl px-4 py-3 text-[16px] outline-none focus:ring-2 transition-all resize-none ${errors.message ? 'border-rose-300 bg-rose-50 focus:ring-rose-500/20' : 'bg-[var(--glass-surface)] border-[var(--glass-border)] focus:ring-[#C9A84C]/20 focus:border-[#C9A84C] focus:bg-[var(--bg-surface)]'}`}
