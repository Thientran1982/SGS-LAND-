...
const GEO_BODY_DATA: Record<string, {
  ...
  '/du-an/vinhomes-hoc-mon': {
    ...
    schema: [
      ...
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP_URL }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP_URL}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'Vinhomes Hóc Môn', item: `${APP_URL}/du-an/vinhomes-hoc-mon` } ] },
    ],
  },
  '/du-an/izumi-city': {
    ...
    schema: [
      ...
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP_URL }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP_URL}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'Izumi City', item: `${APP_URL}/du-an/izumi-city` } ] },
    ],
  },
  '/du-an/the-global-city': {
    ...
    schema: [
      ...
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP_URL }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP_URL}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'The Global City', item: `${APP_URL}/du-an/the-global-city` } ] },
    ],
  },
  '/du-an/vinhomes-can-gio': {
    ...
    schema: [
      ...
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP_URL }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP_URL}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'Vinhomes Cần Giờ', item: `${APP_URL}/du-an/vinhomes-can-gio` } ] },
    ],
  },
};
// ---------------------------------------------------------------------------
