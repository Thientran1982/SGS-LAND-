...
const GEO_BODY_DATA: Record<string, {
  ...
  '/du-an/vinhomes-hoc-mon': {
    ...
    description: 'Vinhomes Hóc Môn 2026: Liền kề từ 5,4 tỷ/căn (thô), CDT hoàn thiện 6,2 tỷ. Liền kề 5x10-15m, Song lập 8-20m, Đơn lập 12x18-20m.',
    h1: 'Vinhomes Hóc Môn – Smart City 4.0 Tây Bắc TP.HCM',
    keywords: 'Vinhomes Hóc Môn, giá Vinhomes Hóc Môn 2026, liền kề Hóc Môn, mua nhà Hóc Môn, SGS LAND',
    url: `${APP}/du-an/vinhomes-hoc-mon`,
    image: `${APP}/og/du-an/vinhomes-hoc-mon`,
    schema: [
      {
        '@type': 'RealEstateListing',
        '@id': `${APP}/du-an/vinhomes-hoc-mon#project`,
        name: 'Vinhomes Hóc Môn',
        description: 'Đô thị Smart City 4.0 tại Hóc Môn TP.HCM. Liền kề từ 5,4 tỷ/căn.',
        url: `${APP}/du-an/vinhomes-hoc-mon`,
        image: `${APP}/og/du-an/vinhomes-hoc-mon`,
        offers: { '@type': 'AggregateOffer', priceCurrency: 'VND', lowPrice: 5400000000, highPrice: 20000000000, offerCount: 500, availability: 'https://schema.org/InStock' },
        address: { '@type': 'PostalAddress', addressLocality: 'Hóc Môn', addressRegion: 'TP.HCM', addressCountry: 'VN' },
        brand: { '@type': 'Brand', name: 'Vinhomes' },
        floorSize: { '@type': 'QuantitativeValue', value: 230, unitText: 'ha' },
        dateModified: '2026-05-31',
      },
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'Vinhomes Hóc Môn', item: `${APP}/du-an/vinhomes-hoc-mon` } ] },
    ],
  },
  '/du-an/izumi-city': {
    title: 'Izumi City Nam Long | Đô Thị Chuẩn Nhật Bản Biên Hòa – SGS LAND',
    description: 'Izumi City 170ha Biên Hòa Đồng Nai. Chuẩn Nhật Bản, 4 tầng tiện ích, Fuji Mart, trường Nhật. Giá nhà phố từ 5 tỷ.',
    h1: 'Izumi City – Đô Thị Chuẩn Nhật 170ha Biên Hòa',
    keywords: 'Izumi City, giá Izumi City, nhà phố Izumi, biệt thự Izumi, Nam Long Group',
    url: `${APP}/du-an/izumi-city`,
    image: `${APP}/og/du-an/izumi-city`,
    schema: [
      {
        '@type': 'RealEstateListing',
        '@id': `${APP}/du-an/izumi-city#project`,
        name: 'Izumi City',
        description: 'Đô thị tich hợp 170ha chuẩn Nhật Bản tại Biên Hòa Đồng Nai.',
        url: `${APP}/du-an/izumi-city`,
        image: `${APP}/og/du-an/izumi-city`,
        offers: { '@type': 'AggregateOffer', priceCurrency: 'VND', lowPrice: 5000000000, highPrice: 25000000000, offerCount: 200, availability: 'https://schema.org/InStock' },
        address: { '@type': 'PostalAddress', addressLocality: 'Biên Hòa', addressRegion: 'Đồng Nai', addressCountry: 'VN' },
        brand: { '@type': 'Brand', name: 'Nam Long Group' },
        floorSize: { '@type': 'QuantitativeValue', value: 170, unitText: 'ha' },
        dateModified: '2026-05-31',
      },
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'Izumi City', item: `${APP}/du-an/izumi-city` } ] },
    ],
  },
  '/du-an/the-global-city': {
    title: 'The Global City Masterise | Đại Đô Thị 117ha An Phú Thủ Đức – SGS LAND',
    description: 'The Global City Masterise Homes 117ha An Phú Thủ Đức TP.HCM. Căn hộ châu Âu, trung tâm thương mại, metro. Từ 80 triệu/m².',
    h1: 'The Global City – Đại Đô Thị Masterise 117ha Thủ Đức',
    keywords: 'The Global City, Masterise Homes, global city giá, căn hộ thu duc',
    url: `${APP}/du-an/the-global-city`,
    image: `${APP}/og/du-an/the-global-city`,
    schema: [
      {
        '@type': 'RealEstateListing',
        '@id': `${APP}/du-an/the-global-city#project`,
        name: 'The Global City',
        description: 'Đô thị quốc tế 117ha do Masterise Homes phát triển tại Thủ Đức TP.HCM.',
        url: `${APP}/du-an/the-global-city`,
        image: `${APP}/og/du-an/the-global-city`,
        offers: { '@type': 'AggregateOffer', priceCurrency: 'VND', lowPrice: 4000000000, highPrice: 30000000000, offerCount: 300, availability: 'https://schema.org/InStock' },
        address: { '@type': 'PostalAddress', addressLocality: 'Thủ Đức', addressRegion: 'TP.HCM', addressCountry: 'VN' },
        brand: { '@type': 'Brand', name: 'Masterise Homes' },
        floorSize: { '@type': 'QuantitativeValue', value: 117, unitText: 'ha' },
        dateModified: '2026-05-31',
      },
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'The Global City', item: `${APP}/du-an/the-global-city` } ] },
    ],
  },
  '/du-an/vinhomes-can-gio': {
    title: 'Vinhomes Cần Giờ 2.870ha – Siêu Đô Thị Lớn Nhất VN | SGS LAND',
    description: 'Vinhomes Cần Giờ (Green Paradise) 2.870ha: siêu đô thị sinh thái lớn nhất Việt Nam. Tư vấn miễn phí.',
    h1: 'Vinhomes Cần Giờ – Siêu Đô Thị Sinh Thái 2.870ha',
    keywords: 'Vinhomes Cần Giờ, green paradise, biệt thự Can Gio, mua Vinhomes Cần Giờ',
    url: `${APP}/du-an/vinhomes-can-gio`,
    image: `${APP}/og/du-an/vinhomes-can-gio`,
    schema: [
      {
        '@type': 'RealEstateListing',
        '@id': `${APP}/du-an/vinhomes-can-gio#project`,
        name: 'Vinhomes Cần Giờ',
        description: 'Siêu đô thị sinh thái 2.870ha tại Cần Giờ TP.HCM do Vinhomes phát triển.',
        url: `${APP}/du-an/vinhomes-can-gio`,
        image: `${APP}/og/du-an/vinhomes-can-gio`,
        offers: { '@type': 'AggregateOffer', priceCurrency: 'VND', lowPrice: 10000000000, highPrice: 200000000000, offerCount: 1000, availability: 'https://schema.org/PreOrder' },
      ...
      { '@type': 'BreadcrumbList', itemListElement: [ { '@type': 'ListItem', position: 1, name: 'Trang Chủ', item: APP }, { '@type': 'ListItem', position: 2, name: 'Dự Án', item: `${APP}/marketplace` }, { '@type': 'ListItem', position: 3, name: 'Vinhomes Cần Giờ', item: `${APP}/du-an/vinhomes-can-gio` } ] },
    ],
  },
};
// ---------------------------------------------------------------------------
