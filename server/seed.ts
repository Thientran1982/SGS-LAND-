...
async function seed() {
  ...
  try {
    ...
    const listingData = [
      { code: 'VGP-A1001', title: 'Can ho Vinhomes Grand Park 2PN', location: 'Q9, TP.HCM', price: 3200000000, area: 69, type: 'APARTMENT', bedrooms: 2, bathrooms: 2, status: 'AVAILABLE', direction: 'East', lat: 10.8498, lng: 106.7719, contactPhone: '0901234567' },
      { code: 'VGP-A2003', title: 'Can ho Vinhomes Grand Park 3PN', location: 'Q9, TP.HCM', price: 4800000000, area: 85, type: 'APARTMENT', bedrooms: 3, bathrooms: 2, status: 'AVAILABLE', direction: 'SouthEast', lat: 10.8512, lng: 106.7742, contactPhone: '0912345678' },
      { code: 'MAP-PH01', title: 'Penthouse Masteri An Phu', location: 'Q2, TP.HCM', price: 15000000000, area: 200, type: 'PENTHOUSE', bedrooms: 4, bathrooms: 3, status: 'AVAILABLE', direction: 'South', lat: 10.8029, lng: 106.7419, contactPhone: '0923456789' },
      { code: 'PMH-VL05', title: 'Biet thu Phu My Hung Q7', location: 'Q7, TP.HCM', price: 25000000000, area: 300, type: 'VILLA', bedrooms: 5, bathrooms: 4, status: 'AVAILABLE', direction: 'SouthEast', lat: 10.7341, lng: 106.7218, contactPhone: '0934567890' },
      { code: 'LAT-01', title: 'Dat nen Long An 100m2', location: 'Ben Luc, Long An', price: 1500000000, area: 100, type: 'LAND', bedrooms: 0, bathrooms: 0, status: 'AVAILABLE', direction: 'East', lat: 10.6485, lng: 106.4744, contactPhone: '0945678901' },
      { code: 'CLT-SH03', title: 'Shophouse Celadon City', location: 'Tan Phu, TP.HCM', price: 8500000000, area: 120, type: 'TOWNHOUSE', bedrooms: 0, bathrooms: 1, status: 'AVAILABLE', direction: 'NorthEast', lat: 10.7895, lng: 106.6216, contactPhone: '0956789012' },
      { code: 'TD-NR01', title: 'Nha rieng Thu Duc 4x15m', location: 'Thu Duc, TP.HCM', price: 5200000000, area: 60, type: 'HOUSE', bedrooms: 3, bathrooms: 2, status: 'AVAILABLE', direction: 'South', lat: 10.8677, lng: 106.7548, contactPhone: '0967890123' },
      { code: 'Q1-STD01', title: 'Studio Q1 cho thue', location: 'Q1, TP.HCM', price: 2800000000, area: 35, type: 'APARTMENT', bedrooms: 1, bathrooms: 1, status: 'AVAILABLE', direction: 'NorthWest', lat: 10.7769, lng: 106.7009, contactPhone: '0978901234' },
      { code: 'VT-BT01', title: 'Biet thu nghi duong Vung Tau', location: 'Vung Tau', price: 12000000000, area: 250, type: 'VILLA', bedrooms: 4, bathrooms: 3, status: 'HOLD', direction: 'East', lat: 10.3457, lng: 107.0843, contactPhone: '0989012345' },
      { code: 'BT-CH01', title: 'Can ho Binh Thanh 2PN', location: 'Binh Thanh, TP.HCM', price: 3500000000, area: 72, type: 'APARTMENT', bedrooms: 2, bathrooms: 2, status: 'AVAILABLE', direction: 'SouthEast', lat: 10.8017, lng: 106.7147, contactPhone: '0990123456' },
      { code: 'Q2-TH01', title: 'Nha pho lien ke Q2', location: 'Q2, TP.HCM', price: 9800000000, area: 100, type: 'TOWNHOUSE', bedrooms: 3, bathrooms: 3, status: 'AVAILABLE', direction: 'SouthWest', lat: 10.8042, lng: 106.7388, contactPhone: '0901111222' },
      { code: 'GV-CH01', title: 'Can ho Go Vap 1PN', location: 'Go Vap, TP.HCM', price: 1800000000, area: 45, type: 'APARTMENT', bedrooms: 1, bathrooms: 1, status: 'SOLD', direction: 'NorthWest', lat: 10.8352, lng: 106.6761, contactPhone: '0912222333' },
      { code: 'Q7-LP01', title: 'Office-tel Q7 Boulevard', location: 'Q7, TP.HCM', price: 2200000000, area: 40, type: 'OFFICE', bedrooms: 0, bathrooms: 1, status: 'AVAILABLE', direction: 'North', lat: 10.7412, lng: 106.7235, contactPhone: '0923333444' },
      { code: 'DAN-DT01', title: 'Dat nen Dong Nai 200m2', location: 'Bien Hoa, Dong Nai', price: 2000000000, area: 200, type: 'LAND', bedrooms: 0, bathrooms: 0, status: 'AVAILABLE', direction: 'East', lat: 10.9575, lng: 106.8427, contactPhone: '0934444555' },
      { code: 'MAP-2PN02', title: 'Can ho Masteri An Phu 2PN', location: 'Q2, TP.HCM', price: 4500000000, area: 75, type: 'APARTMENT', bedrooms: 2, bathrooms: 2, status: 'AVAILABLE', direction: 'SouthEast', lat: 10.8015, lng: 106.7401, contactPhone: '0945555666' },
    ];
