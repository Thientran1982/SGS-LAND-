...
const STATIC_PAGE_META: Record<string, { title: string; description: string; h1?: string; noIndex?: boolean; structuredData?: object }> = {
  '': {
    title: 'SGS LAND | Đại Lý BĐS Hàng Đầu TP.HCM – Aqua City, Global City, Izumi, Vinhomes',
    description: 'SGS LAND — đại lý phân phối bất động sản TP.HCM chuyên Aqua City Novaland (1.000ha), The Global City (117ha), Izumi City (170ha), Vinhomes Cần Giờ (2.870ha). Định giá AI ±5%, tư vấn miễn phí 24/7.',
      ...
      '@graph': [
        {
          ...
          knowsAbout: ['Bất động sản', 'Định giá AI', 'Aqua City Novaland', 'The Global City', 'Izumi City Nam Long', 'Vinhomes Cần Giờ', 'Vinhomes Grand Park', 'Masterise Homes', 'Grand Marina Saigon', 'Thủ Thiêm', 'Đồng Nai', 'Long Thành', 'TP.HCM', 'Bình Dương', 'TP Thủ Đức'],
        },
        {
        ...
        },
        {
          ...
          mainEntity: [
            ...
            { '@type': 'Question', name: 'Dự án nào đang mở bán và có thể đặt chỗ ưu tiên qua SGS LAND?', acceptedAnswer: { '@type': 'Answer', text: 'Tính đến tháng 4/2026: Aqua City Novaland đang bàn giao nhiều phân khu, có sổ hồng riêng. Izumi City Nam Long mở giai đoạn mới từ 2 tỷ. The Global City Masterise đang nhận đặt cọc từ 15 tỷ. Vinhomes Cần Giờ dự kiến mở bán trong năm 2026. Liên hệ 0971 132 378 để nhận bảng giá và tiến độ mới nhất.' } },
        ...
        },
        {
          ...
          numberOfItems: 6,
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Aqua City Novaland', url: `${APP_URL}/du-an/aqua-city`, description: 'Đại đô thị sinh thái 1.000ha tại Nhơn Trạch, Đồng Nai. Novaland. Từ 3 tỷ đồng.' },
            ...
            { '@type': 'ListItem', position: 4, name: 'Vinhomes Cần Giờ', url: `${APP_URL}/du-an/vinhomes-can-gio`, description: 'Siêu đô thị lấn biển 2.870ha tại Cần Giờ, TP.HCM. Vinhomes. Mở bán 2026.' },
    ...
    structuredData: {
      ...
      '@graph': [
        ...
        },
        {
          ...
          numberOfItems: 11,
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Aqua City Novaland', url: `${APP_URL}/du-an/aqua-city`, description: 'Đại đô thị sinh thái 1.000ha, Nhơn Trạch, Đồng Nai. Chủ đầu tư Novaland. Từ 3 tỷ.' },
            ...
            { '@type': 'ListItem', position: 11, name: 'Vinhomes Cần Giờ', url: `${APP_URL}/du-an/vinhomes-can-gio`, description: 'Siêu đô thị lấn biển 2.870ha, Cần Giờ, TP.HCM. Vinhomes. Dự kiến mở bán 2026.' },
          ],
        },
        {
          '@type': 'RealEstateAgent',
