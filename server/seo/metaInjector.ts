...
const STATIC_PAGE_META: Record<string, {
  ...
  'du-an/izumi-city': {
    title: 'Izumi City Nam Long | Đô Thị Chuẩn Nhật 170ha Đồng Nai - SGS LAND',
    description: 'Izumi City Nam Long Biên Hòa: 170ha chuẩn Nhật Bản, Fuji Mart, trường Nhật. Nhà phố 5-12 tỷ, biệt thự 10-25 tỷ. Tư vấn SGS LAND.',
    keywords: 'izumi city nam long, izumi city biên hòa, đô thị nhật bản đồng nai, nhà phố izumi city, biệt thự izumi city, izumi city giá bao nhiêu, mua nhà izumi city',
    image: `${APP_URL}/og/du-an/izumi-city`,
    geoPosition: '10.8500;106.7833',
    geoPlacename: 'Biên Hòa, Đồng Nai',
    geoRegion: 'VN-43',
    h1: 'Izumi City Nam Long',
    structuredData: {
      '@context': 'https://schema.org',
      '@graph': [
        ...
        },
        {
          ...
          ...SGS_FAQ_META,
          mainEntity: [
            { '@type': 'Question', name: 'Izumi City Nam Long có đáng mua không?', acceptedAnswer: { '@type': 'Answer', text: 'Izumi City là đô thị tích hợp chuẩn Nhật 170ha tại Biên Hòa, Đồng Nai do Nam Long và Hankyu Hanshin (Nhật Bản) đồng phát triển. Nổi bật Fuji Mart, trường Nhật, tiêu chuẩn 5 lớp kiểm soát chất lượng — lý tưởng cho ở thực và cho thuê chuyên gia Nhật-Hàn.' } },
            { '@type': 'Question', name: 'Giá nhà phố Izumi City bao nhiêu năm 2026?', acceptedAnswer: { '@type': 'Answer', text: 'Nhà phố liền kề từ 5-12 tỷ; biệt thự song lập từ 10-25 tỷ; căn hộ EHome Southgate từ 1,2 tỷ. Hỗ trợ vay BIDV/VCB tối đa 70%, ân hạn gốc 24 tháng. SGS LAND cập nhật bảng giá miễn phí.' } },
            { '@type': 'Question', name: 'Izumi City cách TP.HCM bao xa?', acceptedAnswer: { '@type': 'Answer', text: 'Izumi City tọa lạc Biên Hòa, Đồng Nai, cách vành đai 3 TP.HCM khoảng 30km. Di chuyển 35-45 phút qua cao tốc TP.HCM–Long Thành–Dầu Giây, kết nối thuận tiện khu Đông và Bình Dương.' } },
            { '@type': 'Question', name: 'Fuji Mart trong Izumi City có gì?', acceptedAnswer: { '@type': 'Answer', text: 'Fuji Mart là TTTM Nhật Bản 30.000m² tích hợp siêu thị, nhà hàng, spa, giải trí. Điểm nổi bật tạo lifestyle Nhật trong khu đô thị, thu hút expat Nhật-Hàn từ KCN Biên Hòa.' } },
            { '@type': 'Question', name: 'Pháp lý Izumi City có an toàn không?', acceptedAnswer: { '@type': 'Answer', text: 'Izumi City pháp lý rõ ràng, sổ hồng riêng từng căn. Nam Long Group (HOSE: NLG) track record bàn giao đúng tiến độ. SGS LAND kiểm tra pháp lý miễn phí trước khi đặt cọc.' } },
            { '@type': 'Question', name: 'Cho thuê Izumi City được bao nhiêu tiền?', acceptedAnswer: { '@type': 'Answer', text: 'Nhà phố 10-20 triệu/tháng; biệt thự 20-40 triệu/tháng. Yield 4-6%/năm nhờ cộng đồng chuyên gia Nhật-Hàn và KCN Biên Hòa 1, 2 lân cận.' } },
            { '@type': 'Question', name: 'Izumi City và Aqua City nên mua đâu?', acceptedAnswer: { '@type': 'Answer', text: 'Izumi City: quy mô 170ha, chuẩn Nhật, gần TP.HCM, giá hợp lý. Aqua City: quy mô 1.000ha, marina, resort. Chọn Izumi nếu ưu tiên chất lượng xây dựng và cộng đồng quốc tế.' } },
            { '@type': 'Question', name: 'SGS LAND hỗ trợ mua Izumi City như thế nào?', acceptedAnswer: { '@type': 'Answer', text: 'SGS LAND là đại lý phân phối uỷ quyền Nam Long: tư vấn phân khu, kiểm tra pháp lý, kết nối vay, hỗ trợ công chứng. Không thu phí từ người mua. Hotline: +84 971 132 378.' } },
          ],
        },
        {
          '@type': 'ApartmentComplex',
          ...
          '@id': `${APP_URL}/du-an/izumi-city#project`,
          name: 'Izumi City Nam Long',
          description: 'Đô thị tích hợp chuẩn Nhật Bản 170ha do Nam Long và Hankyu Hanshin phát triển tại Biên Hòa, Đồng Nai',
          url: `${APP_URL}/du-an/izumi-city`,
          numberOfRooms: '2-3 phòng ngủ',
          floorSize: { '@type': 'QuantitativeValue', minValue: 68, maxValue: 120, unitText: 'm²' },
          amenitiesIncluded: 'Nhật Bản',
          geo: { '@type': 'GeoCoordinates', latitude: 10.8500, longitude: 106.7833 },
          address: { '@type': 'PostalAddress', addressLocality: 'Bình Dương', addressRegion: 'Đồng Nai', addressCountry: 'VN' },
  ...
  'du-an/vinhomes-grand-park': {
    title: 'Vinhomes Grand Park | Siêu Đô Thị 271ha TP. Thủ Đức - SGS LAND',
    description: 'Vinhomes Grand Park TP. Thủ Đức: siêu đô thị 271ha cạnh Metro số 1, công viên 36ha, hồ bơi vô cực. Căn hộ từ 2,5 tỷ, sổ hồng riêng. Tư vấn tại SGS LAND.',
    keywords: 'vinhomes grand park, vinhomes grand park giá, căn hộ vinhomes grand park, vinhomes grand park metro, vinhomes grand park thủ đức, mua căn hộ vinhomes grand park 2026',
    image: `${APP_URL}/og/du-an/vinhomes-grand-park`,
    ...
    structuredData: {
      ...
      '@graph': [
        ...
        },
        {
          ...
          ...SGS_FAQ_META,
          mainEntity: [
            { '@type': 'Question', name: 'Vinhomes Grand Park có đáng mua năm 2026 không?', acceptedAnswer: { '@type': 'Answer', text: 'Vinhomes Grand Park là siêu đô thị 271ha tại TP Thủ Đức, đã bàn giao nhiều phân khu với sổ hồng riêng. Vị trí cạnh ga Metro số 1, tiếp giáp công viên 36ha và hồ bơi vô cực — lý tưởng ở thực lẫn đầu tư cho thuê.' } },
            { '@type': 'Question', name: 'Giá căn hộ Vinhomes Grand Park hiện nay là bao nhiêu?', acceptedAnswer: { '@type': 'Answer', text: 'Thứ cấp 2026: Studio/1PN từ 2,5-3,5 tỷ; 2PN từ 3,5-5 tỷ; 3PN từ 5-7 tỷ. Cho thuê 1PN 8-12 triệu/tháng; 2PN 12-18 triệu/tháng. Tỷ suất yield 5-7%/năm.' } },
            { '@type': 'Question', name: 'Metro số 1 đã hoạt động ảnh hưởng thế nào đến Vinhomes Grand Park?', acceptedAnswer: { '@type': 'Answer', text: 'Metro số 1 đi vào hoạt động 2024 với ga Vinhomes Grand Park ngay trong khu — thời gian di chuyển vào Q1 chỉ còn 25-30 phút. BĐS quanh ga metro TP.HCM thường tăng giá 15-25% sau khi vận hành.' } },
            { '@type': 'Question', name: 'Vinhomes Grand Park và The Global City nên chọn đâu?', acceptedAnswer: { '@type': 'Answer', text: 'Grand Park: đã bàn giao, sổ hồng đầy đủ, giá thứ cấp 2,5-7 tỷ, Metro số 1 ngay cửa — phù hợp ở thực và cho thuê. Global City: nhà phố-biệt thự từ 15 tỷ, tiềm năng tăng giá cao hơn, đang phát triển.' } },
            { '@type': 'Question', name: 'Công viên 36ha trong Vinhomes Grand Park có gì?', acceptedAnswer: { '@type': 'Answer', text: 'Công viên 36ha lớn nhất TP.HCM gồm: hồ bơi vô cực 6.000m², 8 sân thể thao, khu vui chơi trẻ em 5.000m², rừng dừa và đường chạy bộ ven hồ. Đây là điểm khác biệt lớn nhất của Grand Park so với các dự án khác.' } },
            { '@type': 'Question', name: 'Người nước ngoài mua Vinhomes Grand Park được không?', acceptedAnswer: { '@type': 'Answer', text: 'Theo Luật Nhà Ở 2023, người nước ngoài mua tối đa 30% căn hộ/dự án. Grand Park có cộng đồng expat đông, thanh khoản cao. SGS LAND hỗ trợ hợp đồng song ngữ và thủ tục chuyển tiền quốc tế.' } },
            { '@type': 'Question', name: 'Cho thuê Vinhomes Grand Park có dễ không?', acceptedAnswer: { '@type': 'Answer', text: 'Grand Park có thanh khoản cho thuê rất cao: 15.000+ cư dân, gần ĐHQG TP.HCM, Metro số 1. Phòng cho thuê 5-8 triệu; 1PN 8-12 triệu; 2PN 12-18 triệu/tháng. Tỷ lệ lấp đầy >95%.' } },
            { '@type': 'Question', name: 'SGS LAND hỗ trợ mua thứ cấp Vinhomes Grand Park như thế nào?', acceptedAnswer: { '@type': 'Answer', text: 'SGS LAND cung cấp: 500+ giao dịch thứ cấp tham chiếu, định giá AI ±5% miễn phí, kiểm tra sổ hồng độc lập, hỗ trợ đàm phán giá, kết nối ngân hàng vay 70% lãi suất ưu đãi. Không phí từ người mua.' } },
          ],
        },
        {
          '@type': 'ApartmentComplex',
          ...
          '@id': `${APP_URL}/du-an/vinhomes-grand-park#project`,
          name: 'Vinhomes Grand Park',
          description: 'Siêu đô thị tích hợp 271ha do Vinhomes phát triển tại TP. Thủ Đức, TP.HCM — cạnh ga Metro số 1',
          url: `${APP_URL}/du-an/vinhomes-grand-park`,
          numberOfRooms: '1-4 phòng ngủ',
  ...
  'du-an/vinhomes-hoc-mon': {
    ...
    description: 'Vinhomes Hóc Môn Smart City 4.0: đô thị thông minh tại Hóc Môn TP.HCM. Căn hộ 35-150m², 1-4 phòng ngủ, từ 2 tỷ. Kết nối Vành đai 3. Tư vấn tại SGS LAND.',
      ...
      '@graph': [
        ...
        },
        {
          ...
          mainEntity: [
            ...
            { '@type': 'Question', name: 'Giá căn hộ Vinhomes Hóc Môn bao nhiêu?', acceptedAnswer: { '@type': 'Answer', text: 'Vinhomes Hóc Môn studio 35-45m² từ 2-3 tỷ; 1PN từ 2,5-3,5 tỷ; 2PN từ 3,5-5 tỷ; 3-4PN từ 5-12 tỷ; nhà phố từ 8-20 tỷ. Hỗ trợ vay Vietcombank/BIDV tối đa 70%. SGS LAND cập nhật bảng giá miễn phí.' } },
        ...
        },
        {
          ...
          description: 'Đô thị thông minh Smart City 4.0 do Vinhomes–Vingroup phát triển tại huyện Hóc Môn, TP.HCM — kết nối Vành đai 3',
