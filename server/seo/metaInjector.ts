      ...
      '@graph': [
        ...
        },
        {
          ...
          mainEntity: [
            ...
            { '@type': 'Question', name: 'Pháp lý Manhattan Bình Dương có rõ ràng không?', acceptedAnswer: { '@type': 'Answer', text: 'Dự án được cấp sổ hồng 50 năm có gia hạn. Becamex IDC là chủ đầu tư uy tín với 30+ năm kinh nghiệm phát triển đô thị Bình Dương. SGS LAND kiểm tra pháp lý độc lập miễn phí.' } },
            { '@type': 'Question', name: 'Chuyên gia nước ngoài có ưa chuộng Manhattan Bình Dương không?', acceptedAnswer: { '@type': 'Answer', text: 'Bình Dương có 50.000+ chuyên gia nước ngoài (Hàn, Nhật, Đài Loan). Căn hộ chuẩn quốc tế như Manhattan rất được ưa chuộng cho thuê, giá 10-20 triệu/tháng, dòng tiền ổn định.' } },
            { '@type': 'Question', name: 'Becamex IDC là chủ đầu tư như thế nào?', acceptedAnswer: { '@type': 'Answer', text: 'Becamex IDC Corp thuộc UBND tỉnh Bình Dương, là chủ đầu tư KCN và đô thị lớn nhất Đông Nam Bộ với 30+ năm kinh nghiệm phát triển KCN VSIP và Thành Phố Mới Bình Dương.' } },
            { '@type': 'Question', name: 'Vay ngân hàng mua căn hộ Manhattan Bình Dương có dễ không?', acceptedAnswer: { '@type': 'Answer', text: 'Pháp lý minh bạch và Becamex IDC uy tín giúp vay ngân hàng thuận lợi. LTV tối đa 70%, kỳ hạn 25 năm, lãi suất ưu đãi 24 tháng đầu. SGS LAND hỗ trợ hồ sơ vay miễn phí.' } },
            { '@type': 'Question', name: 'Giá thứ cấp căn hộ Manhattan Bình Dương hiện tại?', acceptedAnswer: { '@type': 'Answer', text: '1PN (45-55m²) khoảng 2,5-3,5 tỷ; 2PN (70-90m²) khoảng 4-6 tỷ; 3PN (100-120m²) khoảng 6-9 tỷ. Thanh khoản tốt nhờ nhu cầu thực từ chuyên gia KCN Bình Dương.' } },
          ],
        },
        {
          '@type': 'ApartmentComplex',
