...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="var(--sgs-bg)">
  <tr>
              ...
              <tr>
                <td align="center" style="padding-bottom:8px;">
                  <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td bgcolor="var(--sgs-primary)" style="padding:7px 16px;border-radius:8px;">
        ...
        <tr>
          <td class="email-footer" bgcolor="#F8FAFC" style="padding:18px 40px;border:1px solid #E2E8F0;border-top:none;border-radius:0 0 12px 12px;text-align:center;">
            ...
            <p style="color:#94A3B8;font-size:11px;margin:0;line-height:1.8;font-family:Arial,sans-serif;">
              ...
              <a href="https://sgsland.vn" style="color:var(--sgs-primary);text-decoration:none;font-family:Arial,sans-serif;">sgsland.vn</a>
              &nbsp;&bull;&nbsp;
              <a href="mailto:info@sgsland.vn" style="color:var(--sgs-primary);text-decoration:none;font-family:Arial,sans-serif;">info@sgsland.vn</a>
            </p>
          </td>
        </tr>
      </table>
...
function primaryButton(href: string, label: string): string {
  ...
  <tr>
    <td bgcolor="var(--sgs-primary)" style="border-radius:8px;padding:0;text-align:center;">
...
function linkBox(url: string): string {
  ...
  <tr>
    <td bgcolor="#F8FAFC" style="padding:14px 18px;border:1px solid #E2E8F0;border-radius:8px;">
      ...
      <p style="color:var(--sgs-primary);font-size:11px;word-break:break-all;margin:0;font-family:'Courier New',monospace;line-height:1.5;">${url}</p>
    </td>
  </tr>
</table>`;
}
...
async function sendWelcomeEmail(tenantId: string, to: string, userName: string): Promise<EmailResult> {
  ...
  const featureRow = (text: string) =>
    `<tr><td style="padding:5px 0;color:#334155;font-size:13px;font-family:Arial,sans-serif;">
      <span style="color:var(--sgs-primary);font-weight:bold;">&#10004;</span>&nbsp;&nbsp;${text}
    </td></tr>`;
  const content = `
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#E8EEF5" style="border:1px solid #C7D2FE;border-radius:8px;">
      <tr>
        <td style="padding:14px 20px;text-align:center;">
          ...
          <p style="color:var(--sgs-primary);font-size:16px;font-weight:bold;margin:0;font-family:Arial,sans-serif;">${roleDisplay}</p>
        </td>
      </tr>
    </table>
    ${spacer(28)}
      ...
      <tr><td style="padding:16px 20px;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            ...
            <td style="padding:6px 0;font-family:Arial,sans-serif;"><a href="mailto:${safeEmail}" style="color:var(--sgs-primary);text-decoration:none;font-size:14px;">${safeEmail}</a></td>
          </tr>
          <tr>
            ...
            <td style="padding:6px 0;font-family:Arial,sans-serif;">
              <span style="display:inline-block;background:#E8EEF5;color:var(--sgs-primary);font-size:12px;font-weight:bold;padding:3px 10px;border-radius:20px;font-family:Arial,sans-serif;">${safeSubject}</span>
            </td>
          </tr>
        </table>
      </td></tr>
...
const SUBJECT_GUIDANCE: Record<string, { label: string; icon: string; iconBg: string; guidance: string; cta?: { url: string; label: string } }> = {
  support: {
    ...
    guidance: `
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="padding:4px 0;color:#475569;font-size:13px;font-family:Arial,sans-serif;"><span style="color:var(--sgs-primary);font-weight:bold;">1.</span>&nbsp; Trao đổi yêu cầu & phong cách thiết kế mong muốn</td></tr>
        <tr><td style="padding:4px 0;color:#475569;font-size:13px;font-family:Arial,sans-serif;"><span style="color:var(--sgs-primary);font-weight:bold;">2.</span>&nbsp; Khảo sát mặt bằng & lên phương án thiết kế sơ bộ</td></tr>
        <tr><td style="padding:4px 0;color:#475569;font-size:13px;font-family:Arial,sans-serif;"><span style="color:var(--sgs-primary);font-weight:bold;">3.</span>&nbsp; Báo giá chi tiết & ký hợp đồng tư vấn/thi công</td></tr>
        <tr><td style="padding:4px 0;color:#475569;font-size:13px;font-family:Arial,sans-serif;"><span style="color:var(--sgs-primary);font-weight:bold;">4.</span>&nbsp; Theo dõi tiến độ & bàn giao công trình</td></tr>
      </table>`,
  ...
  const content = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr><td align="center" style="padding-top:6px;">
        <span style="display:inline-block;background:#E8EEF5;color:var(--sgs-primary);font-size:12px;font-weight:bold;padding:4px 12px;border-radius:20px;font-family:Arial,sans-serif;">${escapeHtml(info.label)}</span>
      </td></tr>
    </table>
    ${spacer(24)}
    ${divider()}
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td bgcolor="#F0F4FF" style="padding:14px 18px;border:1px solid #C7D2FE;border-radius:8px;border-left:4px solid var(--sgs-primary);">
    ...
    <p style="color:#94A3B8;font-size:12px;line-height:1.6;margin:0;text-align:center;font-family:Arial,sans-serif;">
      ...
      hoặc email <a href="mailto:info@sgsland.vn" style="color:var(--sgs-primary);text-decoration:none;">info@sgsland.vn</a>
    </p>
  `;
  return sendEmail(DEFAULT_TENANT_ID, {
    to,
...
async function sendNudgeB(tenantId: string, to: string, userName: string): Promise<EmailResult> {
  ...
  const content = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td align="center">
        <a href="${listingUrl}" style="color:var(--sgs-primary);font-size:13px;text-decoration:underline;font-family:Arial,sans-serif;">
...
async function sendNudgeC(tenantId: string, to: string, userName: string): Promise<EmailResult> {
  ...
  const content = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td align="center">
        <a href="${marketUrl}" style="color:var(--sgs-primary);font-size:13px;text-decoration:underline;font-family:Arial,sans-serif;">
...
async function sendNudgeE(tenantId: string, to: string, userName: string): Promise<EmailResult> {
  ...
  const content = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td align="center">
        <a href="${listUrl}" style="color:var(--sgs-primary);font-size:13px;text-decoration:underline;font-family:Arial,sans-serif;">
...
async function sendLeadNurture(
  ...
  const content = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td align="center">
        <a href="tel:${hotline}" style="color:var(--sgs-primary);font-size:14px;font-weight:bold;text-decoration:none;font-family:Arial,sans-serif;">
...
async function sendBillingReceiptEmail(
  ...
  const content = `
    ...
    ${spacer(20)}
    <p style="color:#94A3B8;font-size:12px;line-height:1.6;margin:0;text-align:center;font-family:Arial,sans-serif;">
      ${t.footer} <a href="mailto:billing@sgsland.vn" style="color:var(--sgs-primary);text-decoration:none;">billing@sgsland.vn</a>.
    </p>
  `;
  return sendEmail(tenantId, {
    to,
...
async function sendBillingAdminAlertEmail(
  ...
  const safeSession = escapeHtml(args.sessionId);
  const safeUrl = escapeHtml(args.billingUrl);
  const payerEmailLink = `<a href="mailto:${safePayer}" style="color:var(--sgs-primary);text-decoration:none;">${safePayer}</a>`;
  const detailRow = (label: string, value: string) => `
    <tr>
      <td style="padding:10px 0;border-bottom:1px solid #E2E8F0;color:#64748B;font-size:13px;font-family:Arial,sans-serif;">${label}</td>
      <td align="right" style="padding:10px 0;border-bottom:1px solid #E2E8F0;color:#0F172A;font-size:13px;font-weight:bold;font-family:Arial,sans-serif;">${value}</td>
...
async function sendVendorRejectedEmail(
  ...
  const content = `
    ...
    <p style="color:#475569;font-size:14px;line-height:1.7;margin:0;font-family:Arial,sans-serif;">
      ...
      <a href="mailto:support@sgsland.vn" style="color:var(--sgs-primary);">support@sgsland.vn</a>.
    </p>
  `;
  return sendEmail(tenantId, {
    to,
