...
export const AGENT_ORCHESTRATION_REGISTRY: readonly AgentCapability[] = [
  ...
  { skillKey: 'LANDING_DESIGN', promptKey: 'LANDING_DESIGN_SYSTEM', displayName: 'Landing Design', descriptionKey: 'ai.agent_landing_design_desc', role: 'landing_design_agent', intents: [], mode: 'specialist', ragDomains: ['product'], ownerIntent: 'LANDING (design handoff)' },
