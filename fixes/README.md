...
_Generated: 2026-05-18 by `seo-auto-fix.mjs`_
## Đọc trước khi dùng
...
| `fixes/robots.txt` | Optimal robots.txt with all AI bots allowed | Source-of-truth at public/robots.txt — Cloudflare overrides on prod |
